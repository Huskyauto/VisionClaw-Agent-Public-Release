...
import { sandboxRunDefinition, sandboxReportDefinition } from "../../server/tools/domains/sandbox/definitions";
...
const BORN_MIGRATED_DEF_CONSTS = ["sandboxRunDefinition", "sandboxReportDefinition"];
