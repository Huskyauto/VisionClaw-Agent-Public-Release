...
const BORN_MIGRATED_DEF_CONSTS = ["sandboxRunDefinition", "sandboxReportDefinition", "sandboxPromoteDefinition", "revenueMissionCreateDefinition", "revenueMissionListDefinition", "revenueMissionStatusDefinition", "revenueMissionDraftExperimentDefinition", "missionPortfolioReviewDefinition", "productListingCreateDefinition", "productListingListDefinition", "createPaymentLinkDefinition", "generateAuditFixKitDefinition", "captureListDefinition", "recipeDeriveDefinition", "recipeReplayDefinition", "recipeListDefinition", "recipeDeleteDefinition"];
