...
export const DELIVERABLE_PIPELINES: Record<DeliverableFormat, DeliverablePipeline> = {
  video: {
    ...
    steps: [
      ...
      { tool: "grade_deliverable", required: false, purpose: "W3 vision grader — sample frames, audio LUFS, no >2s black, no meta-narration. Bounded auto-revise loop (revise + re-grade while the score improves, up to max_attempts) if <85.", inputsHint: "{deliverable_type:'video', file_path}", wave: 4, dependsOn: [2] },
