...
export const DEFAULT_SKILLS = [
  {
    name: "Diagram Design", description: "Create polished editorial diagrams (architecture, flowchart, sequence, timeline, funnel, org chart, quadrant, and 20+ more) as self-contained HTML+SVG, brand-matched to the client. Imported from cathrynlavery/diagram-design (MIT).", icon: "GitBranch", category: "creative", enabled: true,
    promptContent: `For any diagram/visual request (flowchart, architecture, sequence, timeline, funnel, org chart, quadrant, flywheel, ER, swimlane, Gantt, etc.): produce ONE self-contained HTML file, inline SVG+CSS only — no JS, external images, or font URLs.
Rules: deletion first — every node earns its place, density ~4/10, >9 nodes = split into two diagrams; accent color on only the 1-2 focal elements; semantic tokens (paper/ink/accent/muted/hairline; default #f5f5f5/#2d3142/#eb6c36); for client work derive tokens from their brand/website first (Bob's brand: agenticcorporation.net); one font family, no shadows/gradient decoration.
Only draw if the visual beats a paragraph or table. Deliver via the normal delivery flow; screenshot to PNG for PDFs/social.`
  },
