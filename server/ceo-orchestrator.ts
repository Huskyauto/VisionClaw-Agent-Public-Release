...
[
  ...
  const fallbackModels = [model, "gpt-5.6-sol", "gpt-5.4", "gemini-3.5-flash", "gpt-4.1", "claude-sonnet-4-5"];
  let client: any;
  ...
  try {
    ...
    for (const retryModel of ["gpt-5.6-sol", "gemini-3.5-flash", "gpt-4.1", "claude-sonnet-4-5"]) {
      try {
