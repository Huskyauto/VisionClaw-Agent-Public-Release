...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  { id: "minimax/minimax-m3", label: "MiniMax M3", provider: "openrouter", tier: "powerful", description: "MiniMax multimodal flagship — served via Profundo flat lane at $0 marginal", capabilities: ["vision", "code", "tools"], costClass: "free", trainingRegime: "rlvr" },
  { id: "xiaomi/mimo-v2.5-pro", label: "MiMo V2.5 Pro", provider: "openrouter", tier: "reasoning", description: "Xiaomi long-horizon reasoning and coding flagship — served via Profundo flat lane at $0 marginal", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "rlvr" },
  ...
  { id: "z-ai/glm-4.7-flash", label: "GLM-4.7 Flash", provider: "openrouter", tier: "fast", description: "30B agentic coder — served via Profundo flat lane at $0 marginal", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
...
export function isOwnerOnlyFinalDecisionModel(modelId: string): boolean {
  return modelId === "gpt-6-astra" || modelId === "claude-fable-5-1";
}
