...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  // Openference Auto Agent lane — catalog verified live 2026-08-22. Local ids
  // remain normalized; providers.ts maps them to the exact upstream spelling.
  { id: "openference/deepseek-v4-pro", label: "DeepSeek V4 Pro (Openference)", provider: "openference", tier: "powerful", description: "DeepSeek high-end reasoning and coding via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/deepseek-v4-pro-0813", label: "DeepSeek V4 Pro 0813 (Openference)", provider: "openference", tier: "powerful", description: "DeepSeek V4 Pro snapshot via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/deepseek-v4-flash-vision-exp", label: "DeepSeek V4 Flash Vision (Openference)", provider: "openference", tier: "powerful", description: "Long-context DeepSeek vision model via the flat-rate Openference Auto Agent lane", capabilities: ["vision", "code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/kimi-k3", label: "Kimi K3 (Openference)", provider: "openference", tier: "powerful", description: "Kimi high-end reasoning model via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/minimax-m3", label: "MiniMax M3 (Openference)", provider: "openference", tier: "powerful", description: "MiniMax high-end reasoning model via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/qwen3.8-27b", label: "Qwen 3.8 27B (Openference)", provider: "openference", tier: "powerful", description: "Qwen reasoning model via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/glm-5.3", label: "GLM 5.3 (Openference)", provider: "openference", tier: "reasoning", description: "GLM agentic reasoning model via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/glm-5.2", label: "GLM 5.2 (Openference)", provider: "openference", tier: "powerful", description: "GLM reasoning model via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "distilled" },
  { id: "openference/ox-alpha", label: "Ox Alpha (Openference)", provider: "openference", tier: "powerful", description: "Long-context reasoning model via the flat-rate Openference Auto Agent lane", capabilities: ["code", "tools"], costClass: "free", trainingRegime: "unknown" },
  { id: "gpt-5.6-sol", label: "GPT-5.6 Sol", provider: "replit", tier: "powerful", description: "Latest OpenAI flagship (strongest 5.6 variant) — Profundo flat-rate route preferred; alternate metered routes require existing cost-policy authorization", capabilities: ["vision", "audio", "code", "tools"], costClass: "free", trainingRegime: "rlvr" },
  { id: "gpt-5.5", label: "GPT-5.5", provider: "replit", tier: "powerful", description: "Previous OpenAI flagship — retired from the flat-rate catalog; use only through a confirmed alternate provider", capabilities: ["vision", "audio", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  ...
  { id: "gpt-5.6-terra", label: "GPT-5.6 Terra", provider: "replit", tier: "powerful", description: "OpenAI 5.6 variant (Terra) — retired from the flat-rate catalog; alternate-provider compatibility only", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "gpt-5.3-codex-spark", label: "GPT-5.3 Codex Spark", provider: "replit", tier: "powerful", description: "OpenAI coding specialist — retired from the flat-rate catalog; alternate-provider compatibility only", capabilities: ["code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "claude-sonnet-5", label: "Claude Sonnet 5", provider: "anthropic", tier: "powerful", description: "Anthropic newest mid-flagship — owner-only direct API jury lane with explicit opt-in and daily spend ceiling", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "claude-haiku-4-5", label: "Claude Haiku 4.5", provider: "anthropic", tier: "fast", description: "Anthropic fast tier — retired from the flat-rate catalog; Claude Runner or direct Anthropic only when available", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "distilled" },
  { id: "minimax/minimax-m3", label: "MiniMax M3", provider: "openrouter", tier: "powerful", description: "MiniMax multimodal flagship — retired from the flat-rate catalog; alternate-provider compatibility only", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "xiaomi/mimo-v2.5-pro", label: "MiMo V2.5 Pro", provider: "openrouter", tier: "reasoning", description: "Xiaomi long-horizon reasoning and coding flagship — retired from the flat-rate catalog; alternate-provider compatibility only", capabilities: ["code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "qwen/qwen3.6-plus", label: "Qwen 3.6 Plus", provider: "openrouter", tier: "powerful", description: "Alibaba Qwen high-end — retired from the flat-rate catalog; alternate-provider compatibility only", capabilities: ["code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "mistralai/mistral-large", label: "Mistral Large", provider: "openrouter", tier: "powerful", description: "Mistral flagship — retired from the flat-rate catalog; alternate-provider compatibility only", capabilities: ["code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "moonshotai/kimi-k2.7-code", label: "Kimi K2.7 Code", provider: "openrouter", tier: "balanced", description: "Moonshot coding specialist — retired from the flat-rate catalog; alternate-provider compatibility only", capabilities: ["code", "tools"], costClass: "paid", trainingRegime: "distilled" },
  ...
  { id: "gpt-6-luna", label: "GPT-6 Luna", provider: "openai", tier: "balanced", description: "OpenAI GPT-6 low-cost workhorse — first metered fallback only after healthy zero-marginal lanes are unavailable; requires the existing metered-spend authorization", capabilities: ["vision", "code", "tools"], costClass: "cheap", trainingRegime: "unknown" },
  { id: "gpt-6-sol", label: "GPT-6 Sol", provider: "openai", tier: "powerful", description: "OpenAI GPT-6 premium reasoning model — deliberate high-risk or failed-verification escalation only; never the routine automatic workhorse", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "unknown" },
  { id: "gpt-6-astra", label: "GPT-6 Astra", provider: "openai", tier: "powerful", description: "OpenAI GPT-6 Astra — best-reasoning owner-only finishing lane; Flex by default at official Batch rates, never automatic customer routing", capabilities: ["code", "tools"], costClass: "paid", trainingRegime: "unknown" },
  ...
  { id: "claude-fable-5", label: "Claude Fable 5", provider: "anthropic", tier: "powerful", description: "LAST-RESORT super-expert escalation ONLY — Profundo flat-rate route is available, but this model remains excluded from automatic proposer, aggregator, and frontier defaults.", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  { id: "claude-fable-5-1", label: "Claude Fable 5.1", provider: "anthropic", tier: "powerful", description: "Anthropic's most capable broadly available model — owner-only explicit final-decision option; 1M context, 128K output, direct API billing at $10/M input and $50/M output with $0.25/M cache reads; never automatic customer routing", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  ...
  { id: "gemini-3.1-pro-preview", label: "Gemini 3.1 Pro", provider: "google", tier: "powerful", description: "Agentic multimodal reasoning model — retired from the flat-rate catalog; direct Google route is metered", capabilities: ["vision", "audio", "video", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  ...
  { id: "google/gemini-3.7-flash", label: "Gemini 3.7 Flash", provider: "openrouter", tier: "powerful", description: "High-quality Gemini evaluator and final-rework model. Metered through OpenRouter at $0.75/M input and $3.75/M output; use this rather than Gemini 2.5 or 3.5 in evaluator roles.", capabilities: ["vision", "audio", "video", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  ...
  { id: "x-ai/grok-4.5", label: "Grok 4.5", provider: "openrouter", tier: "powerful", description: "xAI previous flagship reasoning model (superseded by grok-4.6 at the same price 2026-08-12; alternate-provider fallback only) — 500K ctx, $2/M in $6/M out", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  ...
  // Verified in OpenRouter's live catalog 2026-09-12. Replaces the retired V4 Pro 0813,
  // V4 Flash, and V4 Flash Vision routes with native multimodal V4.1.
  { id: "deepseek/deepseek-v4.1-flash", label: "DeepSeek V4.1 Flash", provider: "openrouter", tier: "powerful", description: "DeepSeek's new multimodal agentic flagship — 1,048,576-token context, strong coding/terminal/long-horizon benchmarks, $0.15/M input and $0.60/M output", capabilities: ["vision", "code", "tools"], costClass: "cheap", trainingRegime: "distilled" },
  { id: "deepseek/deepseek-v3.2", label: "DeepSeek V3.2", provider: "openrouter", tier: "powerful", description: "GPT-5 class reasoning, sparse attention, 164K ctx — $0.269/M in", capabilities: ["code", "tools"], costClass: "cheap", trainingRegime: "distilled" },
  ...
  // Evaluation-only: live OpenRouter catalog verified 2026-08-28. Keep out of
  // defaults/tiers until Hermes tool-use and multimodal evaluations pass.
  { id: "z-ai/glm-5.3-flash", label: "GLM 5.3 Flash (Evaluation)", provider: "openrouter", tier: "fast", description: "Z.ai fast agent model — 1.31M context, text/image/video input, $0.075/M input and $0.25/M output on OpenRouter; explicit evaluation selection only, not a default route", capabilities: ["vision", "video", "code", "tools"], costClass: "cheap", trainingRegime: "distilled" },
  { id: "tencent/hy4-preview", label: "Hy4 Preview (Evaluation)", provider: "openrouter", tier: "powerful", description: "Tencent 770B MoE (49B active) coding and agent model — 1M context, $0.834/M input and $2.501/M output on OpenRouter; explicit owner evaluation only, not a default route", capabilities: ["code", "tools"], costClass: "paid", trainingRegime: "unknown" },
  { id: "stealth/union-alpha", label: "Union Alpha (Synthetic Evaluation)", provider: "openrouter", tier: "powerful", description: "Anonymous OpenRouter preview model for bounded synthetic coding and tool-use evaluation only; prompts may be retained by the provider", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "unknown" },
  { id: "z-ai/glm-5.2", label: "GLM 5.2", provider: "openrouter", tier: "powerful", description: "Z.ai flagship (OpenRouter default GLM as of 2026-06-23) — top-tier reasoning + agentic coding, 1M context — $0.966/M in / $3.036/M out", capabilities: ["vision", "code", "tools"], costClass: "cheap", trainingRegime: "distilled" },
  ...
  { id: "z-ai/glm-4.7-flash", label: "GLM-4.7 Flash", provider: "openrouter", tier: "fast", description: "30B agentic coder — retired from the flat-rate catalog; low-cost alternate-provider route only", capabilities: ["code", "tools"], costClass: "cheap", trainingRegime: "distilled" },

  { id: "nvidia/nemotron-3-super-120b-a12b", label: "Nemotron 3 Super", provider: "openrouter", tier: "powerful", description: "120B MoE (12B active), 1M ctx, Mamba-Transformer hybrid — $0.085/M in / $0.40/M out; preferred cheap-capable OpenRouter fallback", capabilities: ["code", "tools"], costClass: "cheap", trainingRegime: "distilled" },
...
export function getMultimodalModelsForTier(tier: "fast" | "balanced" | "powerful" | "reasoning"): ModelInfo[] {
  return MODEL_REGISTRY.filter(
    m =>
      ...
      !RETIRED_MODEL_IDS.has(m.id) &&
      !isSyntheticEvaluationModel(m.id),
  );
}
...
export const MODEL_MAX_OUTPUT: Record<string, number> = {
  ...
  "openference/deepseek-v4-pro": 384000,
  "openference/deepseek-v4-pro-0813": 384000,
  "openference/deepseek-v4-flash-vision-exp": 384000,
  "openference/kimi-k3": 131072,
  "openference/minimax-m3": 131072,
  "openference/qwen3.8-27b": 65536,
  "openference/glm-5.3": 128000,
  "openference/glm-5.2": 128000,
  "openference/ox-alpha": 131072,
  ...
  "tencent/hy4-preview": 64000,
  "stealth/union-alpha": 32768,
  "z-ai/glm-5.2": 32768,
  "z-ai/glm-5.1": 32768,
...
export function isOwnerOnlyFinalDecisionModel(modelId: string): boolean {
  return (
    modelId === "gpt-6-astra" ||
...
const SYNTHETIC_EVALUATION_MODEL_IDS = new Set([
  "stealth/union-alpha",
]);

export function isSyntheticEvaluationModel(modelId: string): boolean {
  return SYNTHETIC_EVALUATION_MODEL_IDS.has(modelId);
}
