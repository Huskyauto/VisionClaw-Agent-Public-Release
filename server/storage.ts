...
import { RESERVED_KNOWLEDGE_CATEGORIES } from "./lib/reserved-knowledge-categories";
import {
...
export interface IStorage {
  ...
  createKnowledge(data: InsertKnowledge, opts?: { allowReservedCategory?: boolean }): Promise<AgentKnowledge>;
  // R74.13d C3: tenantId is mandatory to prevent cross-tenant knowledge mutation/deletion.
  updateKnowledge(id: number, data: Partial<InsertKnowledge>, tenantId: number, opts?: { allowReservedCategory?: boolean }): Promise<AgentKnowledge | undefined>;
...
export class DatabaseStorage implements IStorage {
  ...
  async createKnowledge(data: InsertKnowledge, opts?: { allowReservedCategory?: boolean }) {
  ...
  async updateKnowledge(id: number, data: Partial<InsertKnowledge>, tenantId: number, opts?: { allowReservedCategory?: boolean }) {
