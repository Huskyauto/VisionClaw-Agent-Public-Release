...
// context window. Gemini 3.1 Pro is Bob's preferred primary (free tier), with
...
export const BIG_CONTEXT_FALLBACK_CHAIN: BigContextEntry[] = [
  {
    ...
    rationale: "Bob's primary pick — Gemini 3.1 Pro, 1M-token window, free via Google integration",
  },
  {
    modelId: "claude-opus-4-7",
    contextWindow: 1_000_000,
    rationale: "Anthropic flagship (Apr 16 2026), 1M context, 128K output, free via Anthropic integration",
  },
  {
