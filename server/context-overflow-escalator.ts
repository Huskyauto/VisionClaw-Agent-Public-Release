...
// context window. Gemini 3.7 Flash is the preferred primary, with
...
//
// Order matters: the preferred capable lane comes first, followed by economical
// long-context alternatives. Metered entries remain subject to the central
// authorization/remapping policy; listing a model here never bypasses cost gates.
// ─────────────────────────────────────────────────────────────────────────────
...
export const BIG_CONTEXT_FALLBACK_CHAIN: BigContextEntry[] = [
  {
    ...
    rationale: "Gemini 3.7 Flash — 1M-token context window through the approved metered OpenRouter lane",
  },
  ...
  // were a top driver of the $440 Opus burst). Opus is jury-only now; Gemini 3.7
  // Flash (1M) leads and Nemotron (1M) / Grok (2M) cover larger prompts.
  {
