...
export async function publishPost(params: {
  ...
  switch (params.platform) {
    ...
    case "instagram":
      ...
      break;
    case "facebook":
      result = await publishToFacebook(connection, params.content, params.imageUrl);
      break;
    case "threads":
    ...
    case "pinterest":
      ...
      break;
    case "youtube":
      result = await publishToYouTube(connection, params.content, params.videoUrl, params.driveFileId, params.title);
      break;
    default:
