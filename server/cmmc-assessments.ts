...
export async function submitCmmcAssessmentByToken(token: string, input: Omit<CmmcSubmission, "company" | "draft" | "typedSignature"> & { draft: unknown }): Promise<{
  ...
  const snapshot = {
    ...
    inScopeLocations: draft.inScopeLocations,
    inScopeAssetCategories: draft.inScopeAssetCategories,
    assetInventoryLocator: draft.assetInventoryLocator,
    fciFlowSummary: draft.fciFlowSummary,
    externalServiceProviders: draft.externalServiceProviders,
    assessmentStartDate: draft.assessmentStartDate,
    assessmentCompletionDate: draft.assessmentCompletionDate,
    assessmentParticipants: draft.assessmentParticipants,
