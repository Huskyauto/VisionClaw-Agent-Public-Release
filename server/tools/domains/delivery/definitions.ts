  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        proofLevel: { type: "string", enum: ["L1", "L2", "L3", "L4", "L5"], description: "Declared per-run proof level (PROOF_LOOPS L1–L5). Advisory: raises docket strictness — L3+ demands completion-verification evidence, L4+ a replay runId, L5 jury concordance; unmet obligations are listed as proof debt and flip the verdict to REVIEW. Higher levels also scan more history (L1 25 rows → L5 200). Default L2 (today's behavior). Never blocks execution or weakens a safety gate." },
      },
      required: [],
    },
  },
