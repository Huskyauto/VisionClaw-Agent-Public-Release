  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        auto_contextualize: { type: "boolean", description: "(R98.27, add_doc only) When true, run the current zero-marginal contextualization model per chunk to generate a 1-2 sentence situating prefix. Stored in chunk.context and used by hybrid search. Default false." },
