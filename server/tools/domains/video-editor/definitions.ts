...
export const videoCutFillersDefinition: ToolDefinition = {
  ...
  function: {
    ...
    description: "Auto-edit a raw video by cutting filler words (um, uh, like, you know...) and dead silence. Pass the words[] from video_transcribe_words. Renders a polished MP4 with 30ms audio fades at every cut so it sounds clean. Drive upload is opt-in.",
    parameters: {
      type: "object",
      properties: {
        ...
        uploadToDrive: { type: "boolean", description: "Explicitly upload finished MP4 to Drive and return shareable link. Default false." },
...
export const videoBurnCaptionsDefinition: ToolDefinition = {
  ...
  function: {
    ...
    description: "Burn TikTok/Reels-style captions onto a video — short UPPERCASE chunks (default 2 words at a time) timed to the speech. Pass the words[] from video_transcribe_words. Returns a new MP4 with captions baked in. Drive upload is opt-in.",
    parameters: {
      type: "object",
      properties: {
        source: { type: "string", description: "Path to the source video file." },
        ...
        uploadToDrive: { type: "boolean", description: "Explicitly upload finished MP4 to Drive. Default false." },
        driveLabel: { type: "string", description: "Drive folder label. Default: 'Video Editor Output'." },
      },
      required: ["source", "words"],
    },
