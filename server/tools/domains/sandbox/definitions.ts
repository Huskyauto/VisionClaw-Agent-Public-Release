    ...
    parameters: {
      ...
      properties: {
        ...
        model: {
          type: "string",
          description:
            "Conversation/orchestration corpus only: the model id to replay under (e.g. 'gpt-5.4').",
        },
        perRunCapUsd: {
          type: "number",
          description:
  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        title: {
          type: "string",
          description: "Short human-readable name for the proposed upgrade (e.g. 'Swap orchestration tier to gpt-5.4').",
        },
        rationale: {
          type: "string",
