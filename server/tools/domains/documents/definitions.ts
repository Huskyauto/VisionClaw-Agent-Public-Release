...
export const createPdfDefinition: ToolDefinition = {
  ...
  function: {
    name: "create_pdf",
    description: "Low-level PDF tool for fillable forms and simple documents ONLY. For reports, analyses, deliverables, or any professional document, use create_styled_report instead — it produces premium executive-quality output with branded cover pages, stats grids, data tables, highlight boxes, and two-column layouts. This tool (create_pdf) supports multi-page documents, header logos, and fillable form fields. Auto-uploads to Google Drive. NEVER use this for reports or deliverables — always prefer create_styled_report.",
    parameters: {
      type: "object",
      properties: {
    ...
    parameters: {
      ...
      properties: {
        ...
        includePlatformBranding: {
          type: "boolean",
          description: "Set false only for customer-owned output that must omit platform logo, QR code, contact details, and promotional pages. Default true.",
        },
