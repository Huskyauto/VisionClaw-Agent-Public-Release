 ...
 * closed APIs (GPT-5.6 Sol, Claude 4.7, Gemini 3.1, DeepSeek V4), so we substitute
...
// token budget before emitting JSON. Standardized to gpt-5.6-sol — Bob's canonical
