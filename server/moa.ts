...
const DISTINCT_FREE_PROPOSERS = ["gpt-5.4", "gpt-5-mini"];
...
const PREMIUM_PROPOSERS = [
  "deepseek/deepseek-v4-pro-0813",   // 1.1154/3.3462 per M — near-Opus agentic scores
  "z-ai/glm-5.2",                    // Profundo flat lane, $0 marginal
...
export async function executeMoA(opts: MoAOptions): Promise<MoAResult> {
  ...
  //       modelfarm lanes (gpt-5.4 / gpt-5-mini) so all of them answer
