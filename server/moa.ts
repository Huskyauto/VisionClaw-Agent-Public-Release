...
// The four canonical high-end models: claude-opus-4-8, gpt-5.5,
...
async function runSteelmanRound(
  ...
  // top-tier models (claude-opus-4-8 + gpt-5.5) — distinct providers chosen for
...
export async function executeMoA(opts: MoAOptions): Promise<MoAResult> {
  ...
  // the unsupported gpt-5.5) onto the SINGLE free gpt-5.4 lane — so a 4-way
