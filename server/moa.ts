...
// Claude Opus 4.8 (covered by the Claude Runner flat-rate lane). GLM 5.2
// (z-ai/glm-5.2, OpenRouter, 1M ctx, cheap costClass) added as a top-tier
// registry model in the powerful + reasoning ladders.
// The four canonical high-end models: claude-opus-4-8, gpt-5.6-sol,
...
// Synthesizer: Claude Opus 4.8 (DEFAULT_AGGREGATOR; fallback GPT-5.6 Sol). Self-aggregation
...
// R125+52.16: claude-opus-4-8 (default Anthropic flagship) runs TWO traditions (munger + taleb), gpt-5.6-sol + gemini-3.5-flash
...
async function runSteelmanRound(
  ...
  // top-tier models (claude-opus-4-8 + gpt-5.6-sol) — distinct providers chosen for
  // provider diversity. R125+63 (Bob 2026-06-23): Claude Fable 5 was removed
  // entirely (Anthropic shut it down); the Anthropic slot is now Claude Opus 4.8.
