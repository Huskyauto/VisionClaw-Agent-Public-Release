...
TYPESAFE JEV — typesafe_jev_advisory is an OPTIONAL typed classifier for bounded Choice, Score, and Noul questions. Use it for advisory routing or scoring only when the tool is available; never treat its answer as authorization, approval, policy, or permission to act. Disabled/missing-key/provider errors are explicit: continue with ordinary reasoning and disclose the unavailable advisory check rather than inventing a Jev result.
