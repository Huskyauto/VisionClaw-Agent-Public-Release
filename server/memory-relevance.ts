...
const LLM_TIMEOUT_MS = 6000; // gpt-5-mini is a reasoning model — 2s always aborted, killing the LLM lane
    ...
    const response = await replitOpenai.chat.completions.create(
      {
        ...
        // No temperature: gpt-5-mini (reasoning model) rejects non-default values.
        // Budget covers reasoning tokens + the JSON answer (thinking-model truncation).
