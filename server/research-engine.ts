...
Allowed model ids include: gpt-4.1, gpt-4.1-mini, claude-sonnet-4-6, claude-opus-4-7, gemini-3-pro-preview, deepseek/deepseek-v3.2.
...
export async function safeApplyProposal(proposalId: number, tenantId: number): Promise<{
  ...
  const tscResult = spawnSync(
    ...
    { timeout: 30_000, encoding: "utf-8", cwd: projectRoot, shell: false },
  );
