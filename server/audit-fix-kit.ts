...
export async function generateAuditFixKit(params: {
  ...
  // Paid deliverables use the centralized flat-rate frontier seat. Resolution
  // remains tenant-scoped in llmFile so provider fallback and attribution are
  // preserved for every generated file.
  const modelId = HIGH_END_WORK_MODEL_ID;
