...
type AuthHelpers = {
  ...
  // Task 124 — approve/apply/revert mutate PLATFORM code, so they require
  // platform admin (tenant #1), not just a flagged tenant admin.
  requirePlatformAdmin: (req: Request, res: any) => boolean;
};
