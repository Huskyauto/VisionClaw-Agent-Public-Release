...
export function registerApiV1Routes(app: Express, helpers: ApiV1Helpers) {
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      ...
      try {
        const settings = await storage.getSettings();
        const finalModel = settings?.defaultModel || "deepseek/deepseek-v3.2";
      ...
      try {
        ...
        if (convId === null) {
          ...
          const conv = await storage.createConversation({
            ...
            model: body.model || settings?.defaultModel || "deepseek/deepseek-v3.2",
            thinking: true,
            thinkingLevel: "auto",
            personaId: resolvedPersonaId,
            tenantId,
      ...
      try {
        if (method === "message/send") {
          ...
          const conv = await storage.createConversation({
            ...
            model: settings?.defaultModel || "deepseek/deepseek-v3.2",
            thinking: true,
            thinkingLevel: "auto",
            personaId: resolvedPersonaId,
            tenantId,
