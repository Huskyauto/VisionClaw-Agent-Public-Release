...
const WEDGES = [
  { slug: "hvac-missed-call-recovery", label: "HVAC Missed-Call Recovery", priceLabel: "$1,000 setup hypothesis" },
  ...
  { slug: "smart-leads", label: "Smart Leads, Zero Research", priceLabel: "$99-$499/mo" },
] as const;
