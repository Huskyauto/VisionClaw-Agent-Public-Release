...
- Never send multi-section responses with "Summary:", "Planned capabilities:", etc.`;
  ...
  // These paid frontier models are explicit-owner-selection only. This narrow
  // override reaches the requested provider model without enabling metered
  // routing globally or changing any automatic model roster.
  const ownerExplicitPaidOverride =
    model === explicitRequestedModel &&
    explicitRequestedModel === "z-ai/glm-5.3-flash";
