export type RevenueWorkspaceKey = "customer-revenue-launchpad" | "fable-5" | "work-opportunity-radar";
...
const WORKSPACES: Record<RevenueWorkspaceKey, RevenueWorkspaceDefinition> = {
  "work-opportunity-radar": {
    key: "work-opportunity-radar",
    parentProjectName: "VisionClaw Work Opportunity Radar",
    parentProjectDescription:
      "Agent-originated project for finding evidence-backed sources of paid work VisionClaw can fulfill.",
    parentProjectTags: ["agent-originated", "money-opportunity", "opportunity-sourcing", "revenue-research"],
    ownerOnly: true,
    ideas: [
      {
        slug: "local-ai-trust-lead-loss-scan",
        title: "Local AI Trust and Lead-Loss Scan",
        summary: "Find local businesses with provable website, mobile, review, form, or AI-search trust gaps and validate one fixed-price audit.",
        targetBuyer: "Local business owner or agency serving local businesses",
        validationState: "Recommended first experiment",
        briefPath: "data/money-opportunities/agent-originated/2026-09-21-work-opportunity-source-channels.md",
        starterPrompt: `Help me run the bounded 20-business Local AI Trust and Lead-Loss Scan. Start by choosing one industry, define the public evidence to inspect, and keep all prospect contact owner-approved. ${MANUAL_VALIDATION_RULE}`,
      },
      {
        slug: "government-institutional-opportunities",
        title: "Government and Institutional Opportunities",
        summary: "Monitor solicitations, sources-sought notices, grants, and subcontracting needs that match VisionClaw's current delivery capabilities.",
        targetBuyer: "Agency, institution, or prime contractor",
        validationState: "Ranked",
        briefPath: "data/money-opportunities/agent-originated/2026-09-21-work-opportunity-source-channels.md",
        starterPrompt: `Help me assess one government or institutional notice as a bounded bid/no-bid opportunity. Verify the requirements, fit, deadline, and evidence before recommending action. ${MANUAL_VALIDATION_RULE}`,
      },
      {
        slug: "job-posting-manual-work-signals",
        title: "Manual-Work Signals in Job Postings",
        summary: "Use repeated hiring for research, reporting, content operations, or coordination as evidence of costly manual workflows.",
        targetBuyer: "Operations leader or department head",
        validationState: "Ranked",
        briefPath: "data/money-opportunities/agent-originated/2026-09-21-work-opportunity-source-channels.md",
        starterPrompt: `Help me examine public job postings for one repeated, expensive manual workflow that could support an AI Task Fit and Human Agency Audit. Keep conclusions task-focused and do not rank workers. ${MANUAL_VALIDATION_RULE}`,
      },
      {
        slug: "agency-consultant-overflow",
        title: "Agency and Consultant Overflow",
        summary: "Identify agencies that sell outcomes VisionClaw can help fulfill through research, audits, reports, decks, media, or content operations.",
        targetBuyer: "Web, marketing, IT, compliance, or advisory firm",
        validationState: "Ranked",
        briefPath: "data/money-opportunities/agent-originated/2026-09-21-work-opportunity-source-channels.md",
        starterPrompt: `Help me define one white-label fulfillment offer for an agency capacity gap. Identify the evidence, narrow deliverable, quality bar, and owner approval before contact. ${MANUAL_VALIDATION_RULE}`,
      },
      {
        slug: "public-complaint-review-patterns",
        title: "Public Complaint and Review Patterns",
        summary: "Find repeated concrete pain in public reviews and forums, then test a narrow assessment, remediation, or monitoring offer.",
        targetBuyer: "Product owner, service business, or affected customer segment",
        validationState: "Ranked",
        briefPath: "data/money-opportunities/agent-originated/2026-09-21-work-opportunity-source-channels.md",
        starterPrompt: `Help me analyze one public complaint pattern without collecting unnecessary personal data. Separate repeated evidence from anecdotes and design one reversible validation step. ${MANUAL_VALIDATION_RULE}`,
      },
    ],
  },
