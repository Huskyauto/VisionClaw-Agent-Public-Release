...
const MODEL_COST_PER_1K: Record<string, { in: number; out: number }> = {
  ...
  "deepseek/deepseek-v4-flash-0731": { in: 0.000065, out: 0.00018 },
  "deepseek/deepseek-v4-flash": { in: 0.000088606, out: 0.000177212 },
  "deepseek/deepseek-v4-pro-0813": { in: 0.0011154, out: 0.0033462 },
...
function cacheFactors(model: string): { read: number; write: number } {
  ...
  if (m === "gpt-6-astra" || m === "gpt-6-astra:flex") return { read: 0.1, write: 1.25 };
...
export function estimateCostUsd(
  ...
  const isAstra = model === "gpt-6-astra" || model === "gpt-6-astra:flex";
  const longContext = isAstra && tokensIn > 272_000;
