    ...
    if (deps.collapseTracker) {
      ...
      if (collapse.collapsed) {
        ...
        lastResult = await finish("rolled_back", attemptNumber, {
          ...
          reasons: [
            `Prior-collapse: proposal near-identical (cosine ${collapse.similarity == null ? "?" : collapse.similarity.toFixed(3)}) to a previously failed attempt — apply/verify skipped.`,
          ],
