...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  { id: "x-ai/grok-4.5", label: "Grok 4.5", provider: "openrouter", tier: "powerful", description: "xAI newest flagship reasoning model (verified live 2026-07-11) — 500K ctx, $2/M in $6/M out. Strong general reasoning; for parallel multi-agent orchestration or >500K context keep using grok-4.20-multi-agent (2M ctx, cheaper at $1.25/$2.50 per M)", capabilities: ["vision", "code", "tools"], costClass: "paid", trainingRegime: "rlvr" },
  ...
  { id: "z-ai/glm-5.2", label: "GLM 5.2", provider: "openrouter", tier: "powerful", description: "Z.ai flagship (OpenRouter default GLM as of 2026-06-23) — top-tier reasoning + agentic coding, 1M context — $0.98/M in / $3.08/M out", capabilities: ["vision", "code", "tools"], costClass: "cheap", trainingRegime: "distilled" },
