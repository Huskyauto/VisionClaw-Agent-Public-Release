...
- [ ] I understand this is a public-mirror proposal; it will not be adopted into the private project without maintainer review.
- [ ] If this changes workflows, dependencies, auth, safety, tools, schema, migrations, scripts, or deployment files, I explained the security impact below.
