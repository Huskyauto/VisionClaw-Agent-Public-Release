...
const PLANS = [
  { name: "Free Trial", price: 0, features: ["Full VisionClaw experience", "5 conversations", "All 12 AI agents", "Voice, tools & memory"], trial: true },
  ...
  { name: "Enterprise", price: 299, features: ["Full 12-agent team", "Autonomous heartbeat", "Priority support"] },
];
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SeoHead
        title="Sign Up Free — VisionClaw"
        description="Create your free VisionClaw account. Access 14 AI agents, 152 tools, and full document production. No credit card required. Start in 30 seconds."
        canonical=""
      />
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold mb-2" data-testid="text-signup-title">Get Started with VisionClaw</h1>
