  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SeoHead
        ...
        description="Create your free VisionClaw Agent account. Access 18 AI agents with distinct personalities, 408 tools, 145 AI skill surfaces, and full document production. No credit card required. Start in 30 seconds."
        canonical=""
      />
