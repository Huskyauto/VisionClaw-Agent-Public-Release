...
const PLANS = [
  { name: "Free Trial", price: 0, features: ["Full VisionClaw Agent experience", "5 conversations", "All 18 AI agents", "Voice, tools & memory"], trial: true },
  ...
  { name: "Enterprise", price: 299, features: ["Full 18-agent team", "Autonomous heartbeat", "Priority support"] },
];
...
export default function SignupPage() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      console.warn("[signup] resend-verification failed (non-fatal):", err?.message || err);
      setError("Couldn't resend the email just now — please try again in a minute.");
    }
    setResending(false);
  };
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SeoHead
        ...
        description="Create your free VisionClaw Agent account. Access 18 AI agents with distinct personalities, 413 tools, 146 reference surfaces, and full document production. No credit card required. Start in 30 seconds."
        canonical=""
      />
