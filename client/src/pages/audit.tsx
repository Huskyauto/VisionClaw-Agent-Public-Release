...
function computeQualVerdict(a: Record<QualAxisId, number>): QualVerdict {
  ...
  if (core >= 2) {
    ...
    if (a.reasoning === 2 && a.dataSources >= 1) {
      ...
      vca = "VisionClaw runs this as an autonomous workflow with its 394-tool action layer + delegation.";
    }
  }
          ...
          <CardContent className="pt-6">
            <blockquote className="space-y-3">
              <p className="text-lg italic text-foreground" data-testid="text-founder-quote">
                "I built a 394-tool AI platform alone. Then I audited it myself and scored 60/100. Here's the audit you can run on yours."
              </p>
