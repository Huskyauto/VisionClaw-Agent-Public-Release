              ...
              <div key={i} className="flex items-start gap-4 p-3 rounded-lg border border-border bg-card">
                ...
                <p className="text-sm text-muted-foreground">
                  {m.event.startsWith("Current state:")
                    ? "Current state: 18 built-in personas + unlimited Claude Code imports, 417 tools, 137 active capabilities, 167 declared / 244 live tables, 756 platform indexes, and 80 curated AI models plus 1000+ discovered daily via OpenRouter. Muse S1 complex-objective dry runs now distinguish internal ensemble analysis from real tool execution; production publish remains pending explicit owner approval."
                    : m.event}
                </p>
              </div>
            ))}
