      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardContent className="p-5">
                <h3 className="font-semibold mb-2">413 Integrated Tools</h3>
              ...
              <div key={i} className="flex items-start gap-4 p-3 rounded-lg border border-border bg-card">
                ...
                <p className="text-sm text-muted-foreground">
                  {m.event.startsWith("Current state:")
                    ? "Current state: 18 built-in personas + unlimited Claude Code imports, 413 tools, 134 active capabilities, 230 live tables, 679 platform indexes, and 67 curated AI models plus 1000+ discovered daily via OpenRouter."
                    : m.event}
                </p>
              </div>
            ))}
