...
const CURRENT_MILESTONES = [
  ...
  { year: "R132.5", event: "Current release: 418 registered tools, 138 active capabilities, 68 total skills, 178 declared / 258 live tables, 825 platform indexes, and 41 governance rules." },
];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SeoHead
        ...
        description={`Meet ${config.platformName}'s 18 specialist agents and the governed platform behind them: 418 registered tools, 138 active capabilities, 68 skills, tenant isolation, human approvals, and cost-aware model routing.`}
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardContent className="p-5">
                <h3 className="font-semibold mb-2">418 Registered Tools</h3>
