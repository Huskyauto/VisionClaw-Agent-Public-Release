      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10">
        ...
        >
          ...
          <p className="mt-3 text-lg text-white/50 max-w-2xl mx-auto">
            ...
            operating with {stats.governanceRules} governance rules, 68 total skills, and {stats.tools || 418} registered tools. The current platform spans 178 declared / 258 live database tables and routes across 79 curated models plus 1000+ models discovered through OpenRouter.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-10">
          ...
          <StatCard label="Tools" value={stats.tools || 418} icon={Wrench} color="from-orange-500 to-red-500" delay={0.2} />
