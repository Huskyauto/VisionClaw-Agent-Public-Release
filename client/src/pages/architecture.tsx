      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10">
        ...
        >
          ...
          <p className="mt-3 text-lg text-white/50 max-w-2xl mx-auto">
            ...
            operating with {stats.governanceRules} governance rules across {stats.skills} skills and {stats.tools || 415}+ tools, with R79 MarTech Bundle (6 new per-tenant brand-voice and social-content tools — build_voice_profile, get_voice_profile, generate_hooks, format_post, generate_content_matrix, score_post — hardened against prompt injection with fenced voice context, marker-stripping, and string-aware balanced-bracket JSON parsing), R77.5 KisMATH Reasoning Audit Rail (regime-aware routing, audit_reasoning_step + verify_math_chain tools, REASONING_GLUE_MISSING flag), R77.6 + R77.7 security hardening (15 surgical fixes from a four-architect + six-pronged whole-app review), and R76 Trust-Tier Policy Engine + Deliverable Contract Verification (Doctrine #12) all gating every risky action and every customer-facing claim.
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-10">
          ...
          <StatCard label="Tools" value={stats.tools || 415} icon={Wrench} color="from-orange-500 to-red-500" delay={0.2} />
