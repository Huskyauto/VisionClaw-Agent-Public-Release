      ...
      <Card data-testid="card-disclaimer" className="border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950/30">
        <CardContent className="pt-4 flex gap-2 items-start text-sm">
          ...
          <div className="text-amber-900 dark:text-amber-200">
            Educational analysis only — not personalized investment advice. Forecasts use recent free Yahoo market data with a Stooq fallback + LLM technical reasoning. Confidence is calibrated, not guaranteed. Portfolio holdings (symbols + share counts) are sent to the LLM provider for diversification analysis — do not enter holdings you consider confidential.
          </div>
        </CardContent>
      </Card>
