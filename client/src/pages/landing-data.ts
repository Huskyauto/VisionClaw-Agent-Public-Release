...
export const PERSONA_LIST = [
  ...
  { name: "Neptune", role: "Deep Research Specialist", icon: Globe, description: "Conducts complex multi-source investigations and produces structured, evidence-backed research with explicit confidence levels." },
  ...
  { name: "Minerva", role: "Chief Planner — Strategic Plan Architect", icon: Workflow, description: "Turns complex goals into sequenced, dependency-aware plans with explicit success criteria and human approval boundaries." },
  { name: "Robert", role: "Personal & Emotional-Life Specialist", icon: Bot, description: "Builds long-term personal context for journaling, emotional check-ins, pattern recognition, and practical next actions." },
  { name: "Hermes", role: "Growth Hacker — Acquisition & Experiments", icon: Activity, description: "Runs evidence-led acquisition experiments, measures conversion and retention, and scales or stops channels based on results." },
  { name: "Echo", role: "UX Researcher — Voice of the User", icon: Search, description: "Turns interviews, feedback, and observed behavior into concise, actionable product findings without leading the user." },
];
