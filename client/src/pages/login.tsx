...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SeoHead
        title="Sign In — VisionClaw"
        description="Sign in to your VisionClaw account. Access your AI agents, projects, conversations, and autonomous operations."
        canonical=""
      />
      ...
      <div className="flex items-center justify-center p-4 pt-24">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardTitle data-testid="text-login-title">Welcome to VisionClaw</CardTitle>
            <CardDescription>
