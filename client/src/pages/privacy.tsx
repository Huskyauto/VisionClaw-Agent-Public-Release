      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Payment processing is handled by third-party processors. Card and subscription payments are processed by Stripe; cryptocurrency payments are processed by Coinbase Commerce. We do not store your complete credit card details or wallet private keys. These processors may collect and store your payment details in accordance with their own privacy policies. We retain transaction records (amounts, dates, and processor transaction identifiers) for billing, accounting, and legal compliance.
            </p>
            <h3 className="text-lg font-medium mt-4 mb-2">Connected Account Data (Integrations)</h3>
            <p className="text-muted-foreground leading-relaxed">
              If you choose to connect third-party accounts — such as Google (Gmail, Google Drive, Google Calendar, Google Sheets) or Microsoft (Outlook, OneDrive) — we access the data those integrations require to perform the actions you request, such as reading and sending email, managing calendar events, and reading or writing files. Access is granted through OAuth; we store the authorization tokens securely and never see your account password. We access connected-account data only to perform the tasks you direct the Service to perform, and you may revoke access at any time from your Google or Microsoft account settings or from within the Service.
            </p>
            <h3 className="text-lg font-medium mt-4 mb-2">Messaging Channels and Email</h3>
            <p className="text-muted-foreground leading-relaxed">
              If you interact with the Service through external messaging channels — Telegram, Discord, WhatsApp, or X (Twitter) — the messages you exchange over those channels are processed by the respective platform under its own privacy policy, and message content is stored by us as part of your conversation history. Inbound and outbound email handled by the Service is processed through AgentMail, our email delivery provider. Use of these channels is optional; if you do not connect or message us through them, no data flows through those providers.
            </p>
            <h3 className="text-lg font-medium mt-4 mb-2">Uploaded Files</h3>
            <p className="text-muted-foreground leading-relaxed">
              Files you upload to the Service (documents, images, audio, video, and other content) are stored so the Service can process them, generate deliverables, and make them available to you. Uploaded files are subject to the same tenant isolation, retention, and deletion rules as your other data.
            </p>
            <h3 className="text-lg font-medium mt-4 mb-2">Voice Data</h3>
            <p className="text-muted-foreground leading-relaxed">
              If you use voice features, your audio may be transcribed and processed to generate responses, and text may be converted to speech using third-party voice synthesis providers (including ElevenLabs). Voice transcriptions are stored as part of your conversation history.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              To provide AI capabilities, your messages, uploaded files, and other content you submit may be processed by third-party AI providers including OpenAI, Anthropic, Google (Gemini), xAI, and additional models accessed through OpenRouter. Voice synthesis is provided by ElevenLabs. These providers process your data according to their respective privacy policies and data processing agreements. We select providers that offer appropriate data protection standards. Your conversation data is sent to these providers for processing and is not used to train their models outside of what their standard policies allow. If you connect your own AI provider API keys (BYOK), your requests are sent directly to your chosen provider under your own agreement with that provider.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-3">
              A summary of our third-party processors: <strong>Stripe</strong> and <strong>Coinbase Commerce</strong> (payments); <strong>OpenAI, Anthropic, Google, xAI, OpenRouter</strong> (AI processing); <strong>ElevenLabs</strong> (voice synthesis); <strong>Google and Microsoft</strong> (optional account integrations you connect); <strong>AgentMail</strong> (email delivery); <strong>Telegram, Discord, WhatsApp, and X (Twitter)</strong> (optional messaging channels you use to reach the Service); <strong>Replit</strong> (hosting and infrastructure).
            </p>
          </section>
