...
const UPDATES: UpdateEntry[] = [
  {
    ...
    highlights: [
      ...
      {
        icon: "Film",
        text: "Current platform totals remain unchanged: 417 tools, 137 capabilities, 18 personas, 169 declared / 247 live tables, 777 indexes, 68 skills, and 41 governance rules.",
      },
    ],
  },
