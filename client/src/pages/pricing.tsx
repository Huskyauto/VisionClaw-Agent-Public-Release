...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      "100% of the source — 417 tools, 18 personas, 68 total skills, 169 declared / 247 live tables, 777 platform indexes, 41 governance rules, AES-256-GCM encryption at rest for credentials, HMAC-SHA256 hashed auth secrets",
