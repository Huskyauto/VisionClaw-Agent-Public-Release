...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      "100% of the source — 399 tools (incl. R79 MarTech Bundle: build_voice_profile / get_voice_profile / generate_hooks / format_post / generate_content_matrix / score_post), 16 personas, 216 tables, 143 reference surfaces (43 skills + 62 db + 38 output-skills), 41 governance rules, AES-256-GCM encryption at rest for credentials, HMAC-SHA256 hashed auth secrets",
