...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      "100% of the source — 415 tools (including the R79 MarTech Bundle), 18 personas, 67 total skills, 182 declared / 237 live tables, 720 platform indexes, 41 governance rules, AES-256-GCM encryption at rest for credentials, HMAC-SHA256 hashed auth secrets",
