...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      "Access to all 418 registered tools",
  ...
  },
  {
    ...
    features: [
      "100% of the source — 418 registered tools, 18 personas, 68 total skills, 178 declared / 258 live tables, 825 platform indexes, 41 governance rules, AES-256-GCM encryption at rest for credentials, HMAC-SHA256 hashed auth secrets",
