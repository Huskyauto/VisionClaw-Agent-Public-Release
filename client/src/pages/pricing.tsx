...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      "100% of the source — 417 tools, 18 personas, 67 total skills, 167 declared / 244 live tables, 756 platform indexes, 41 governance rules, AES-256-GCM encryption at rest for credentials, HMAC-SHA256 hashed auth secrets",
