      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              {config.platformName} is an agentic AI platform that provides multi-persona AI assistants, autonomous task execution, memory systems, voice interactions (including AI voice synthesis), AI media generation (video, audio, images, and documents), file upload and delivery, optional third-party account integrations (such as Google and Microsoft services), and related AI-powered tools. The Service is provided on a subscription basis with various tiers offering different levels of access and capabilities.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Paid subscriptions are billed monthly through Stripe. You authorize us to charge your payment method on a recurring basis. We also accept cryptocurrency payments for certain purchases through Coinbase Commerce; cryptocurrency payments are final once confirmed on-chain except where a refund is required by law or granted at our discretion. You may cancel your subscription at any time, and cancellation will take effect at the end of your current billing period. Refunds are handled on a case-by-case basis at our discretion. You are responsible for any taxes, network fees, or exchange-rate fluctuations associated with your chosen payment method.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3">5a. Third-Party Account Integrations</h2>
            <p className="text-muted-foreground leading-relaxed">
              The Service allows you to optionally connect third-party accounts such as Google (Gmail, Drive, Calendar, Sheets) and Microsoft (Outlook, OneDrive). By connecting an account, you authorize the Service to access and act on that account on your behalf — for example, reading and sending email, managing calendar events, and reading or writing files — solely to perform the tasks you request. You are responsible for ensuring you have the right to grant this access and for complying with the third party's terms of service. You may revoke access at any time; revocation may limit features that depend on the integration. The Service can also interact with you over external messaging channels — Telegram, Discord, WhatsApp, and X (Twitter) — and send or receive email through our email delivery provider (AgentMail); your use of those channels is also subject to the respective platform's terms. We are not responsible for the availability, accuracy, or conduct of third-party services.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1 mt-2">
              ...
              <li>Use AI features to generate spam, deceptive content, impersonations, or unsolicited mass communications</li>
              <li>Use voice synthesis features to impersonate any person without their consent or to create misleading audio</li>
              <li>Use connected third-party accounts (e.g., email or calendar integrations) to send spam or violate the third party's terms</li>
              <li>Attempt to circumvent usage limits, safety systems, tenant isolation, or content policies</li>
            </ul>
          </section>
