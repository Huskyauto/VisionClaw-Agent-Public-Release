...
const visionClawAnswers = [
  ...
  },
  {
    ...
    tools: "413 tools, fully tenant-isolated, drift-checked on every restart (R70/R71), tenant-isolation hardened end-to-end (R74.5), self-curating playbook injected via R74.13z-quint+3 Tool Sommelier",
    icon: Globe,
...
export default function ComparePage() {
  ...
  const personaCount = data?.personas?.length ?? 18;
          ...
          {stats && (
            ...
            >
              {[
                ...
                { label: "Tools", value: stats.tools || 413, icon: Wrench, color: "text-blue-400" },
                { label: "Skills", value: stats.skills || 62, icon: Lightbulb, color: "text-cyan-400" },
                { label: "Gov Rules", value: stats.governanceRules || 41, icon: Shield, color: "text-emerald-400" },
        ...
        <section className="max-w-7xl mx-auto px-6 pb-8">
          <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-0 md:gap-0 items-start">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-white/30 text-xs mt-2">What 18 agents do for you</p>
            </div>
          </div>
        </section>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { icon: Network, text: "18 specialized agents collaborate through an internal message bus — they don't just execute, they coordinate" },
