...
const visionClawAnswers = [
  ...
  },
  {
    ...
    tools: "414 tools, fully tenant-isolated, drift-checked on every restart (R70/R71), tenant-isolation hardened end-to-end (R74.5), self-curating playbook injected via R74.13z-quint+3 Tool Sommelier",
    icon: Globe,
          ...
          {stats && (
            ...
            >
              {[
                ...
                { label: "Tools", value: stats.tools || 414, icon: Wrench, color: "text-blue-400" },
