...
const visionClawAnswers = [
  ...
  {
    agent: "195 Integrated Tools",
    capability: "Google Drive, Workspace, email, X/Twitter, WhatsApp, Telegram, browser, Firecrawl — already wired",
    tools: "195 tools across 14 categories, all tenant-isolated",
    icon: Globe,
...
export default function ComparePage() {
  ...
  const personaCount = data?.personas?.length ?? 14;
          ...
          {stats && (
            ...
            >
              {[
                ...
                { label: "Tools", value: stats.tools || 195, icon: Wrench, color: "text-blue-400" },
                { label: "Skills", value: stats.skills || 61, icon: Lightbulb, color: "text-cyan-400" },
        ...
        <section className="max-w-7xl mx-auto px-6 pb-8">
          <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-0 md:gap-0 items-start">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-white/30 text-xs mt-2">What 14 agents do for you</p>
            </div>
          </div>
        </section>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { icon: Network, text: "14 specialized agents collaborate through an internal message bus — they don't just execute, they coordinate" },
                    { icon: Shield, text: "40 governance rules control autonomy levels, spending limits, and approval workflows" },
