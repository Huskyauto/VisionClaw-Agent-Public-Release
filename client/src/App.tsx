...
const AdminCmmcPage = lazy(() => import("@/pages/admin-cmmc"));
const AdminToolsPage = lazy(() => import("@/pages/admin-tools"));
const TypeSafeJevPage = lazy(() => import("@/pages/typesafe-jev"));
const WebsiteAuditPage = lazy(() => import("@/pages/website-audit"));
const ExecutiveReportPage = lazy(() => import("@/pages/executive-report"));
const SmartLeadsPage = lazy(() => import("@/pages/smart-leads"));
const AdminResearchReportPage = lazy(() => import("@/pages/admin-research-report"));
const AdminDigitalProductsPage = lazy(() => import("@/pages/admin-digital-products"));
const AdminPaymentLinksPage = lazy(() => import("@/pages/admin-payment-links"));
const AdminMissedCallRecoveryPage = lazy(() => import("@/pages/admin-missed-call-recovery"));
...
const DfyIntakePage = lazy(() => import("@/pages/dfy-intake"));
...
const AdminAiTaskFitAuditPage = lazy(() => import("@/pages/admin-ai-task-fit-audit"));
...
const CmmcQuestionnairePreviewPage = lazy(() => import("@/pages/cmmc-questionnaire-preview"));
const CmmcAssessmentPage = lazy(() => import("@/pages/cmmc-assessment"));
...
const AgentScorecardsPage = lazy(() => import("@/pages/agent-scorecards"));
const CapabilityMapPage = lazy(() => import("@/pages/capability-map"));
const WorkflowReplayPage = lazy(() => import("@/pages/workflow-replay"));
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-6">
          <div className="max-w-md text-center space-y-4">
            ...
            <p className="text-xs text-muted-foreground font-mono bg-muted p-2 rounded">
              {/* Never render raw error.message — backend error text can carry internal
                  paths or integration details. Show only the error name (safe class). */}
              {this.state.error?.name || "Error"} — details logged
            </p>
  ...
  return (
    <Suspense fallback={<PageLoadingFallback />}>
      <Switch>
        ...
        <Route path="/agent-scorecards" component={AgentScorecardsPage} />
        <Route path="/capability-map" component={CapabilityMapPage} />
        <Route path="/replay" component={WorkflowReplayPage} />
        ...
        {isAdmin && <Route path="/admin/cmmc" component={AdminCmmcPage} />}
        {isAdmin && <Route path="/admin/tools" component={AdminToolsPage} />}
        {isAdmin && <Route path="/admin/tools/typesafe-jev" component={TypeSafeJevPage} />}
        {isAdmin && <Route path="/admin/website-audit" component={WebsiteAuditPage} />}
        {isAdmin && <Route path="/admin/executive-report" component={ExecutiveReportPage} />}
        {isAdmin && <Route path="/admin/smart-leads" component={SmartLeadsPage} />}
        {isAdmin && <Route path="/admin/research-report" component={AdminResearchReportPage} />}
        {isAdmin && <Route path="/admin/digital-products" component={AdminDigitalProductsPage} />}
        {isAdmin && <Route path="/admin/payment-links" component={AdminPaymentLinksPage} />}
         {isAdmin && config.hvacMissedCallRecoveryEnabled && <Route path="/admin/missed-call-recovery" component={AdminMissedCallRecoveryPage} />}
        ...
        {isAdmin && <Route path="/admin/sandbox" component={AdminSandboxPage} />}
        ...
        {isPlatformAdmin && <Route path="/income-opportunities/ai-task-fit-audit" component={AdminAiTaskFitAuditPage} />}
    ...
    return (
      <Suspense fallback={<PageLoadingFallback />}>
        <Switch>
          ...
          <Route path="/dfy-intake/:token" component={DfyIntakePage} />
      ...
      <QueryClientProvider client={queryClient}>
        <TooltipProvider>
          <ThemeProvider>
            <Suspense fallback={<PageLoadingFallback />}>
            <Switch>
              <Route path="/cmmc/questionnaire-preview" component={CmmcQuestionnairePreviewPage} />
              <Route path="/cmmc/assessment/:token" component={CmmcAssessmentPage} />
