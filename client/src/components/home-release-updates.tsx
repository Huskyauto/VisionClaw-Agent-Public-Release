...
export function HomeReleaseUpdates({ releaseExpanded, toggleRelease }: {
  ...
  return (
    <>
        ...
        >
          <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-indigo-600 text-white leading-none shrink-0 mt-0.5">R125+155.18+sec NEW</span>
        ...
        {showAllUpdates && (<div id="home-older-updates" className="space-y-5 [&>button]:relative [&>button]:before:absolute [&>button]:before:right-3 [&>button]:before:top-3 [&>button]:before:rounded-sm [&>button]:before:bg-muted [&>button]:before:px-1.5 [&>button]:before:py-0.5 [&>button]:before:text-[10px] [&>button]:before:font-bold [&>button]:before:content-['Historical']">
