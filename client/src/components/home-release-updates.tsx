...
export function HomeReleaseUpdates({ releaseExpanded, toggleRelease }: {
  ...
  return (
    <>
        {/* R127+sec (2026-09-11) — NEW (violet): state-grounded plan memory. */}
        <button
        ...
        >
          <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-violet-600 text-white leading-none shrink-0 mt-0.5">R127+sec NEW</span>
        ...
        {/* R126+sec (2026-09-11) — NEW (orange): AI Task Fit & Human Agency Audit. */}
        <button
        ...
        >
          <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-orange-600 text-white leading-none shrink-0 mt-0.5">R126+sec NEW</span>
          <div className="min-w-0 flex-1">
