...
export function HomeReleaseUpdates({ releaseExpanded, toggleRelease }: {
  ...
  return (
    <>
        {/* R125+155.7+sec (2026-09-04) — NEW (violet): bounded relational memory context. */}
        <button
        ...
        >
          <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-violet-600 text-white leading-none shrink-0 mt-0.5">R125+155.7+sec NEW</span>
