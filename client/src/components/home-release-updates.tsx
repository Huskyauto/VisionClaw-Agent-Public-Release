...
export function HomeReleaseUpdates({ releaseExpanded, toggleRelease }: {
  ...
  return (
    <>
        {/* R125+155.3 (2026-09-03) — NEW (emerald): economical parallel-agent workers. */}
        <button
        ...
        >
          <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-emerald-600 text-white leading-none shrink-0 mt-0.5">R125+155.3 NEW</span>
