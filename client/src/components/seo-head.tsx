...
export function SeoHead({
  ...
  const effectiveDescription = useCurrentPlatformDescription
    ? `R125+155.19: Bounded Human-AI Synergy Trial and a 21-idea Opportunity Bank. VisionClaw owners get a tenant-scoped, report-only deterministic three-arm measurement with zero model calls and zero inference spend; no IQ, hiring, causal, or autonomous claims. Current platform: 417 tools, 137 capabilities, 18 personas, 166 declared / 243 live tables, 747 indexes, 67 skills, 41 governance rules, and 80 curated models.`
    : currentDescription;
  const effectiveOgDescription = useCurrentPlatformDescription
    ? "R125+155.19: Bounded Human-AI Synergy Trial and 21-idea Opportunity Bank; owner-only, tenant-scoped, report-only, zero model calls/spend."
