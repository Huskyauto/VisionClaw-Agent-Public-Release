...
export function SeoHead({
  ...
  const effectiveDescription = useCurrentPlatformDescription
    ? `R126+sec: AI Task Fit & Human Agency Audit is an owner-reviewed manual paid service with exact-off production launch, durable replay-safe orders, bounded killable PDF inspection, reviewed delivery, and employment-decision and affiliation safeguards; storefront approval remains pending. Prior R125+155.23+sec: Commercial Research Frontier provides an owner-only evidence workspace with bounded navigation and deterministic score transparency. Current platform: 417 tools, 137 capabilities, 18 personas, 168 declared / 246 live tables, 767 indexes, 67 skills, 41 governance rules.`
    : currentDescription;
  const effectiveOgDescription = useCurrentPlatformDescription
    ? "R126+sec: owner-reviewed manual paid AI Task Fit & Human Agency Audit with durable order replay, bounded killable PDF inspection, reviewed delivery, and employment-decision safeguards; storefront remains pending, while prior R125+155.23+sec Commercial Research Frontier history remains available."
