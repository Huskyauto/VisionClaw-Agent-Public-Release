...
export function SeoHead({
  ...
  const effectiveDescription = useCurrentPlatformDescription
    ? `R132.6 adds evidence-bounded capability maturity that separates repeatable narrow performance from breadth, human benchmarks, operational evidence, and AGI claims without adding authority. R132.5 lets Jev consume descriptor-safe structured state. Current platform: 418 tools, 178 declared / 258 live tables, 825 live indexes (573 non-PK), 138 capabilities, 68 total platform skills, 107 reference surfaces, 18 personas, 41 governance rules.`
    : currentDescription;
  const effectiveOgDescription = useCurrentPlatformDescription
    ? "R132.6 adds evidence-bounded capability maturity with conservative narrow-performance claims and no added authority or autonomy."
