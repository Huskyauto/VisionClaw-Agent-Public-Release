...
export function SeoHead({
  ...
  const effectiveDescription = useCurrentPlatformDescription
    ? `R125+155.11: Deploy an 18-agent AI team with 417 total registered tools, 80 curated AI models, 135 capabilities, and 242 live tables. The unavailable Hy3 route has been retired, while Tencent Hy4-preview remains an explicitly owner-selected evaluation lane rather than an automatic paid replacement.`
    : currentDescription;
  const effectiveOgDescription = useCurrentPlatformDescription
    ? "R125+155.11: unavailable Hy3 route retired without substituting paid Hy4 into automatic routing; 417 tools and 80 curated AI models."
