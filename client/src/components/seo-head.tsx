...
export function SeoHead({
  ...
  const effectiveDescription = useCurrentPlatformDescription
    ? `R125+155.9+sec: Deploy an 18-agent AI team with 417 total registered tools, 80 curated AI models, 135 capabilities, and 242 live tables. Claude Fable 5.1 is an explicit owner-only final-decision lane whose output remains withheld until usage is durably accounted, alongside proof-backed capability evidence and deterministic research citations.`
    : currentDescription;
  const effectiveOgDescription = useCurrentPlatformDescription
    ? "R125+155.9+sec: owner-only Claude Fable 5.1 with fail-closed usage accounting, proof-backed capability evidence, deterministic citations, 417 tools, and 80 curated AI models."
