  ...
  return (
    <Sidebar className="border-r border-sidebar-border">
      ...
      <SidebarFooter className="border-t border-sidebar-border p-2 max-h-[40vh] overflow-y-auto">
        ...
        {isAdmin && (
            <NavSection title="Income Opportunities" icon={Lightbulb} defaultOpen={[ "/admin/income-opportunities", "/admin/ai-task-fit-audit", "/admin/research-frontier" ].includes(location)} accent badge="NEW" touchFriendly>
            <NavLink path="/admin/income-opportunities" icon={Sparkles} label="Opportunity Bank" badge={`${INCOME_OPPORTUNITIES.length} IDEAS`} touchFriendly />
             {isPlatformAdmin && <NavLink path="/admin/ai-task-fit-audit" icon={ClipboardCheck} label="Task Fit Audit" badge="LAUNCH" touchFriendly />}
