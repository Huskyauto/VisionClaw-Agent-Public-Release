      ...
      <SidebarFooter className="border-t border-sidebar-border p-2 max-h-[40vh] overflow-y-auto">
          ...
          <SidebarMenuItem>
            ...
            >
              <a href="/updates" onClick={(e) => { e.preventDefault(); navigateTo("/updates"); }}>
                ...
                <span className="ml-auto px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-rose-600 text-white leading-none" data-testid="badge-updates-new">
                  R125+155.9+sec
                </span>
              </a>
            </SidebarMenuButton>
        ...
        {isAdmin && (
          <NavSection title="Admin" icon={Shield} defaultOpen={["/heartbeat", "/agentic", "/payments", "/settings", "/compare", "/admin/tools", "/operator"].some(p => location === p)}>
            ...
            <NavLink path="/activity?filter=security" icon={ShieldCheck} label="Security Audit" badge="R125+155.9+sec" badgeClass="ml-auto text-[10px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded-sm bg-rose-600 text-white leading-none" />
