  ...
  return (
    <Sidebar className="border-r border-sidebar-border">
      ...
      <SidebarFooter className="border-t border-sidebar-border p-2 max-h-[40vh] overflow-y-auto">
          ...
          <SidebarMenuItem>
            ...
            >
              <a href="/updates" onClick={(e) => { e.preventDefault(); navigateTo("/updates"); }}>
                ...
                <span className="ml-auto px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-amber-600 text-white leading-none" data-testid="badge-updates-new">
                  R125+153+sec
                </span>
              </a>
            </SidebarMenuButton>
        ...
        {isAdmin && (
          <NavSection title="Income Products" icon={DollarSign} defaultOpen={["/admin/website-audit", "/audit", "/admin/research-report", "/admin/digital-products", "/admin/payment-links", "/admin/archive-rescue", "/admin/wedges", "/admin/revenue-missions", "/admin/service-orders"].some(p => location === p)} accent badge="$$">
            ...
            <NavLink path="/admin/executive-report" icon={Gauge} label="Executive Report" badge="NEW" />
        ...
        {isAdmin && (
          <NavSection title="Admin" icon={Shield} defaultOpen={["/heartbeat", "/agentic", "/payments", "/settings", "/compare", "/admin/tools", "/operator"].some(p => location === p)}>
            ...
            <NavLink path="/activity?filter=security" icon={ShieldCheck} label="Security Audit" badge="R125+153+sec" badgeClass="ml-auto text-[10px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded-sm bg-amber-600 text-white leading-none" />
