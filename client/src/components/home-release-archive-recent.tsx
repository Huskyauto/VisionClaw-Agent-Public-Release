...
export function HomeReleaseArchiveRecent({ releaseExpanded, toggleRelease }: {
  ...
  return (
    ...
    >
      <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-fuchsia-600 text-white leading-none shrink-0 mt-0.5">R125+155+sec8 Historical</span>
    ...
    >
      <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-sm bg-cyan-600 text-white leading-none shrink-0 mt-0.5">R125+155+sec6 Historical</span>
      <div className="min-w-0 flex-1">
