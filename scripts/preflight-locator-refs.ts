...
// glob@7 (CJS) has no ESM named export `glob` — import default + promisify.
import globCjs from "glob";
import { promisify } from "node:util";
const glob = promisify(globCjs) as (pattern: string, opts?: object) => Promise<string[]>;
