...
const HEADLINE_STATS = {
  tools: "407 (+ 4 MCP memory tools, external surface)",
  skills: "43 (.agents/) + 62 (db) + 38 (output-skills/) = 143 reference surfaces",
  personas: "16",
  capabilities: "129",
  tables: "222",
  indexes: "642",
  ...
  try {
    ...
    const sections: any[] = [
      ...
      },
      {
        ...
        content:
          "Every skill currently registered in the skills table (62 entries). A separate count of 43 lives on disk under .agents/skills/ — these are agent operating runbooks, not user-runnable AI skills. Both numbers are canonical; surfaces should mention all three as 43 (.agents) + 62 (DB) + 38 (output-skills) = 143 reference surfaces.",
