...
const HEADLINE_STATS = {
  ...
  skills: "44 (.agents/) + 62 (db) + 38 (output-skills/) = 144 reference surfaces",
  personas: "16",
  capabilities: "131",
  tables: "224",
  indexes: "642",
  ...
  try {
    ...
    const sections: any[] = [
      ...
      },
      {
        ...
        content:
          "Every skill currently registered in the skills table (62 entries). A separate count of 44 lives on disk under .agents/skills/ — these are agent operating runbooks, not user-runnable AI skills. Both numbers are canonical; surfaces should mention all three as 44 (.agents) + 62 (DB) + 38 (output-skills) = 144 reference surfaces.",
