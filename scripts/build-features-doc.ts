...
const HEADLINE_STATS = {
  tools: "408 (+ 4 MCP memory tools, external surface)",
  skills: "46 (.agents/) + 62 (db) + 38 (output-skills/) = 146 reference surfaces",
  personas: "18",
  capabilities: "131",
  tables: "226",
  indexes: "667",
  ...
  try {
    ...
    const sections: any[] = [
      ...
      },
      {
        ...
        content:
          "Every skill currently registered in the skills table (62 entries). A separate count of 46 lives on disk under .agents/skills/ — these are agent operating runbooks, not user-runnable AI skills. Both numbers are canonical; surfaces should mention all three as 46 (.agents) + 62 (DB) + 38 (output-skills) = 146 reference surfaces.",
