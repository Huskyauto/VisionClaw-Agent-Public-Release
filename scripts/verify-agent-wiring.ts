...
const MAIN_AGENT_ONLY_SKILLS = new Set<string>([
  ...
  "pre-build-design-gate", // main-agent-only operational skill: 7-question pre-build stress test (cost math, state, failure story, dedup, limits, kill switch, dispersal)
  "post-edit-pipeline",
