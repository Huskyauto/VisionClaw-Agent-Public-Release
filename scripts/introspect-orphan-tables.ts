...
const ORPHANS = [
  ...
  "research_experiments", "research_programs", "research_schedules", "research_sessions",
  "sandbox_improvements", "sandbox_results", "sandbox_runs",
  "social_connections", "social_posts",
  "commerce_products", "mission_evidence", "mission_experiments", "revenue_missions", "agent_capital",
];
...
// changes. These ${ORPHANS.length} tables existed in the live DB but were not previously
