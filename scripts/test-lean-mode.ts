...
// Task 104 girth split — synthesizeResults moved to server/ceo-plan-synthesis.ts
const synthSrc = fs.readFileSync("server/ceo-plan-synthesis.ts", "utf-8");
const hasSynthReport = synthSrc.includes("Lean steps:");
