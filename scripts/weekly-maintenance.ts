 ...
 * Runs the 13-pass weekly sweep and writes a summary to /tmp/weekly-maintenance-<date>.json
...
async function main() {
  ...
  const independent = passDefs.filter(([n]) => shouldRun(n) && [1, 2, 3, 6, 7, 8, 9, 10, 11, 12, 13].includes(n));
