# VisionClaw — Fork & Deploy Setup Guide

This guide walks you through configuring your own instance of VisionClaw after forking the repository.

## Prerequisites

- A Replit account (or any Node.js 20+ hosting environment)
...
| `GITHUB_TOKEN` | GitHub personal access token for push access |
...
- **14 AI Personas**: VisionClaw, Felix, Forge, Teagan, Blueprint, Chief of Staff, Proof, Radar, Neptune, Apollo, Atlas, Cassandra, Luna, Scribe
- **195 Tools**: Research, documents, email, CRM, code execution, and more
