...
- Your own Replit account (or any Node.js 22.12+ hosting environment)
...
- **165 declared / 242 live database tables**, **743 platform indexes**, **135 active capabilities**, 67 total skills + 41 governance rules, and an **80-model** curated AI registry + 1000+ daily catalog discovery
