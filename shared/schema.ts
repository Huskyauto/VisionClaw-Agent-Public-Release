import { pgTable, serial, text, timestamp, integer, boolean, jsonb, bigint, real, varchar, index, numeric, uniqueIndex, vector, primaryKey, doublePrecision } from "drizzle-orm/pg-core";
