...
flowchart TB
    ...
    subgraph TOOLS["Tool layer — 399 governed tools"]
        direction TB
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="docs/images/tour-command-center.jpg"><img src="docs/images/tour-command-center.jpg" alt="Command Center — 16 agents, 399 tools, 45 curated models + 1000+ daily catalog, live workflows" /></a>
...
| Frontend Pages | 40+ |
| API Endpoints | 300+ |
| Database Tables | 216 live (declared delta in schema.ts) |
...
server/                       # Express backend
  ...
  tools/                      # 399 tools — per-domain modules (70+ domains) + shared middleware
  ...
  seed.ts                     # Database seeding (216 tables, 41 rules, 16 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (216 tables)
scripts/
...
1. The database auto-creates all 216 tables and full index set
