...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (229 tables, 41 rules, 18 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (175 declared; 229 live — see docs/CURRENT_PLATFORM_TOTALS.md)
scripts/
...
1. The database auto-creates all 229 tables and full index set
