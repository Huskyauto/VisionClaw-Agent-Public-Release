...
flowchart TB
    ...
    subgraph TOOLS["Tool layer — 404 governed tools"]
        direction TB
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="docs/images/tour-command-center.jpg"><img src="docs/images/tour-command-center.jpg" alt="Command Center — 16 agents, 404 tools, 45 curated models + 1000+ daily catalog, live workflows" /></a>
...
server/                       # Express backend
  ...
  tools/                      # 404 tools — per-domain modules (70+ domains) + shared middleware
