...
| Frontend Pages | 40+ |
| API Endpoints | 300+ |
| Database Tables | 228 live (declared delta in schema.ts) |
...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (228 tables, 41 rules, 18 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (175 declared; 228 live — see docs/CURRENT_PLATFORM_TOTALS.md)
scripts/
...
1. The database auto-creates all 228 tables and full index set
