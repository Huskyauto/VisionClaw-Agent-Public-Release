...
| `tool-smoke-test` | Staged smoke-test + documentation program across all 395 tools (20 stages of 20; 108 live-safe / 287 doc-only — doc-only tools are never auto-invoked); $0 / no LLM / no tenant, one stage per session | **COMPLETE — 395/395 tools verified · 20/20 stages signed off · 0 flags** (refreshed 2026-07-04) |
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="docs/images/tour-command-center.jpg"><img src="docs/images/tour-command-center.jpg" alt="Command Center — 16 agents, 395 tools, 45 curated models + 1000+ daily catalog, live workflows" /></a>
...
server/                       # Express backend
  ...
  tools/                      # 395 tools — per-domain modules (70+ domains) + shared middleware
