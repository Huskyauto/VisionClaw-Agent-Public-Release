...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (211 tables, 41 rules, 16 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (211 tables)
scripts/
...
1. The database auto-creates all 211 tables and full index set
