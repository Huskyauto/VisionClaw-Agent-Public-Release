...
| Frontend Pages | 40+ |
| API Endpoints | 300+ |
| Database Tables | 221 live (declared delta in schema.ts) |
...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (221 tables, 41 rules, 16 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (221 tables)
scripts/
...
1. The database auto-creates all 221 tables and full index set
