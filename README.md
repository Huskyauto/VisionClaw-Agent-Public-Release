...
| Frontend Pages | 40+ |
| API Endpoints | 300+ |
| Database Tables | 222 live (declared delta in schema.ts) |
...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (225 tables, 41 rules, 18 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (174 declared; 225 live — see docs/CURRENT_PLATFORM_TOTALS.md)
scripts/
...
1. The database auto-creates all 225 tables and full index set
