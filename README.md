...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (227 tables, 41 rules, 18 personas)
...
1. The database auto-creates all 227 tables and full index set
