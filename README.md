...
### Multi-Tenant AI Agent Workspace — Documents, Research & Workflows
...
VisionClaw is an open-source, multi-tenant AI platform where 14 specialized agents work together to produce real deliverables — research reports, legal documents, financial models, marketing campaigns, slide decks, spreadsheets, and PDFs.
...
**129,000+ lines of TypeScript. 40+ pages. 195+ tools. 37+ AI models. 6 providers.**
...
The platform implements six core agentic patterns, each battle-tested in daily production use:
