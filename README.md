...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (223 tables, 41 rules, 16 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (223 tables)
scripts/
...
1. The database auto-creates all 223 tables and full index set
