...
flowchart TB
    ...
    subgraph TOOLS["Tool layer — 396 governed tools"]
        direction TB
...
| `tool-smoke-test` | Staged smoke-test + documentation program across all 398 tools (20 stages of 20; doc-only tools are never auto-invoked); $0 / no LLM / no tenant, one stage per session | **COMPLETE — 396 of 396 cataloged verified at the 2026-07-11 refresh; the 2 sandbox tools added in R125+137.39 await the next re-scan verified · 20/20 stages signed off · 0 flags** (refreshed 2026-07-11) |
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="docs/images/tour-command-center.jpg"><img src="docs/images/tour-command-center.jpg" alt="Command Center — 16 agents, 398 tools, 45 curated models + 1000+ daily catalog, live workflows" /></a>
...
server/                       # Express backend
  ...
  tools/                      # 398 tools — per-domain modules (70+ domains) + shared middleware
  ...
  seed.ts                     # Database seeding (215 tables, 41 rules, 16 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (215 tables)
scripts/
...
1. The database auto-creates all 215 tables and full index set
