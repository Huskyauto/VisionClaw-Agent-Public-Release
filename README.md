...
flowchart TB
    ...
    subgraph TOOLS["Tool layer — 408 governed tools"]
        direction TB
...
| `tool-smoke-test` | Staged smoke-test + documentation program across all 408 tools (21 stages of 21; doc-only tools are never auto-invoked); $0 / no LLM / no tenant, one stage per session | **COMPLETE — 407 of 407 cataloged verified · 21/21 stages signed off · 0 flags** (refreshed 2026-07-24) |
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="docs/images/tour-command-center.jpg"><img src="docs/images/tour-command-center.jpg" alt="Command Center — 18 agents, 408 tools, 45 curated models + 1000+ daily catalog, live workflows" /></a>
...
| Frontend Pages | 40+ |
| API Endpoints | 300+ |
| Database Tables | 226 live (declared delta in schema.ts) |
...
server/                       # Express backend
  ...
  tools/                      # 408 tools — per-domain modules (70+ domains) + shared middleware
  ...
  seed.ts                     # Database seeding (226 tables, 41 rules, 18 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (175 declared; 226 live — see docs/CURRENT_PLATFORM_TOTALS.md)
scripts/
...
1. The database auto-creates all 226 tables and full index set
