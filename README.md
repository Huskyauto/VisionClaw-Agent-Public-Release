...
Roughly 180k lines of TypeScript across 460+ files. 40+ pages. **391 tools · 126 active capabilities · 16 personas · 197 tables · 41 governance rules · 579 production indexes · 6 AI providers · 6 deployment targets.** Live, always-current counts: [`docs/CURRENT_PLATFORM_TOTALS.md`](docs/CURRENT_PLATFORM_TOTALS.md). Browsable indexes: [`docs/tools.md`](docs/tools.md) · [`docs/personas.md`](docs/personas.md).
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="docs/images/tour-command-center.jpg"><img src="docs/images/tour-command-center.jpg" alt="Command Center — 16 agents, 391 tools, 41 curated models + 1000+ daily catalog, live workflows" /></a>
...
server/                       # Express backend
  ...
  tools.ts                    # 391 tool definitions and execution handlers
  routes.ts                   # 300+ API endpoints
  site-config.ts              # Centralized env-driven configuration
  seed.ts                     # Database seeding (197 tables, 41 rules, 16 personas)
...
shared/
  schema.ts                   # Drizzle ORM schema (197 tables)
scripts/
...
1. The database auto-creates all 197 tables and full index set
