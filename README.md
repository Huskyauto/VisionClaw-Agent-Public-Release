...
flowchart TB
    ...
    subgraph TOOLS["Tool layer — 414 governed tools"]
        direction TB
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <a href="docs/images/tour-command-center.jpg"><img src="docs/images/tour-command-center.jpg" alt="Command Center — 18 agents, 414 tools, 77 curated models + 1000+ daily catalog, live workflows" /></a>
...
| Built-in Tools | 414 |
| AI Models in Core Registry | 77 curated |
...
| Frontend Pages | 40+ |
| API Endpoints | 300+ |
| Database Tables | 179 declared / 234 live |
...
- **77 Curated AI Models in the Core Registry** with cost-aware auto-routing across OpenAI, Anthropic, Google Gemini, xAI Grok, OpenRouter, and Perplexity. Bring your own provider credentials — API billing is governed by each provider's own terms.
...
server/                       # Express backend
  ...
  tools/                      # 414 tools — per-domain modules (70+ domains) + shared middleware
...
shared/
  schema.ts                   # Drizzle ORM schema (179 declared / 234 live — see docs/CURRENT_PLATFORM_TOTALS.md)
scripts/
...
1. The database auto-creates all 234 live tables and full index set
