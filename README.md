...
| `tool-smoke-test` | Staged smoke-test + documentation program across all 407 tools (21 stages of 21; doc-only tools are never auto-invoked); $0 / no LLM / no tenant, one stage per session | **COMPLETE — 407 of 407 cataloged verified · 21/21 stages signed off · 0 flags** (refreshed 2026-07-24) |
...
server/                       # Express backend
  ...
  seed.ts                     # Database seeding (225 tables, 41 rules, 16 personas)
