...
> Completed: 2026-07-02 (refreshed 2026-07-24 after the R125+137.83 wiring sweep) · Program: 21 stages · Result: **407/407 tools verified, 0 attention flags**
...
gated tool. This report is the full, transparent catalog of all 396 tools: what each
...
- **Safety rule:** tools marked **doc-only** (288) are destructive, sensitive, costly,
...
| Metric | Value |
|---|---|
| Tools verified | 396 / 396 (100%) |
| Stages signed off | 20 / 20 |
| Attention flags | 0 |
| live-safe / doc-only split | 108 / 288 |
| Registry fingerprint | f5cbf3054822b43b |
...
## `create_pdf`  —  **doc-only**
Low-level PDF tool for fillable forms and simple documents ONLY. For reports, analyses, deliverables, or any professional document, use create_styled_report instead — it produces premium executive-quality output with branded cover pages, stats grids, data tables, highlight boxes, an
