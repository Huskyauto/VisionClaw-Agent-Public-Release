...
**Last verified:** 2026-07-17 (auto-generated by `scripts/refresh-totals.ts`)
...
| **Built-in tools** | **396** | `rg "registerTool(...)" server/ \| sort -u \| wc -l` |
...
| **Production indexes (non-PK)** | **414** | `SELECT count(*) FROM pg_indexes WHERE schemaname='public' AND indexname NOT LIKE '%_pkey'` |
