...
**Last verified:** 2026-08-18 (auto-generated by `scripts/refresh-totals.ts`)
...
| **Production indexes (non-PK)** | **453** | `SELECT count(*) FROM pg_indexes WHERE schemaname='public' AND indexname NOT LIKE '%_pkey'` |
...
- **229 live** — includes the four externally-managed Stripe
