...
**Last verified:** 2026-08-06 (auto-generated by `scripts/refresh-totals.ts`)
...
| **Production indexes (non-PK)** | **443** | `SELECT count(*) FROM pg_indexes WHERE schemaname='public' AND indexname NOT LIKE '%_pkey'` |
