...
**Last verified:** 2026-08-02 (auto-generated by `scripts/refresh-totals.ts`)
...
| **Database tables (declared)** | **171** | `rg -c "= pgTable(" shared/schema.ts` |
...
| **Production indexes (non-PK)** | **442** | `SELECT count(*) FROM pg_indexes WHERE schemaname='public' AND indexname NOT LIKE '%_pkey'` |
...
- **171 declared** — auditable, version-controlled,
