...
\restrict GH61KSoARsWhjyeSSVUqPELFq9eMz7BLDtrdTa7adTDTWdOdeQ2ubuzTvorf0aR
...
--
-- Name: memory_ascii_canonical(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.memory_ascii_canonical(value text) RETURNS text
...
--
-- Name: memory_tombstone_guard(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.memory_tombstone_guard() RETURNS trigger
    LANGUAGE plpgsql
...
--
-- Name: account_erasure_receipts; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.account_erasure_receipts (
    ...
    CONSTRAINT account_erasure_receipts_erased_count_check CHECK ((erased_count >= 0)),
    CONSTRAINT account_erasure_receipts_item_count_check CHECK ((item_count >= 0))
);


--
-- Name: account_erasure_receipts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.account_erasure_receipts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: account_erasure_receipts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.account_erasure_receipts_id_seq OWNED BY public.account_erasure_receipts.id;
...
--
-- Name: agent_capital; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: agent_capital_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: agent_capital_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: agent_recovery_manifests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agent_recovery_manifests (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    run_id integer,
    conversation_id integer,
    ...
    payload jsonb DEFAULT '{}'::jsonb NOT NULL,
    next_cursor jsonb DEFAULT '{}'::jsonb NOT NULL,
    idempotency_key text NOT NULL,
...
--
-- Name: agent_recovery_manifests_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agent_recovery_manifests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: agent_recovery_manifests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.agent_recovery_manifests_id_seq OWNED BY public.agent_recovery_manifests.id;
...
CREATE TABLE public.agent_runs (
    ...
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    completed_at timestamp without time zone,
    recovery_event_sequence integer DEFAULT 0 NOT NULL
);
...
CREATE TABLE public.agent_settings (
    ...
    default_model text DEFAULT 'gpt-5.4'::text NOT NULL,
...
--
-- Name: artifact_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.artifact_records (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    project_id integer,
    scope_key text DEFAULT 'tenant'::text NOT NULL,
    logical_name text NOT NULL,
    artifact_kind text DEFAULT 'document'::text NOT NULL,
    ...
    error_message text,
    metadata jsonb DEFAULT '{}'::jsonb NOT NULL,
    durable_at timestamp without time zone,
...
--
-- Name: artifact_records_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.artifact_records_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: artifact_records_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.artifact_records_id_seq OWNED BY public.artifact_records.id;
...
--
-- Name: cmmc_assessment_invitations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cmmc_assessment_invitations (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: cmmc_assessment_invitations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cmmc_assessment_invitations_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cmmc_assessment_invitations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cmmc_assessment_invitations_id_seq OWNED BY public.cmmc_assessment_invitations.id;


--
-- Name: cmmc_assessment_snapshots; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cmmc_assessment_snapshots (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    assessment_id integer NOT NULL,
    revision integer NOT NULL,
    ...
    authorized_official_name character varying(200) NOT NULL,
    authorized_official_title character varying(200) NOT NULL,
    authorized_official_email character varying(320) NOT NULL,
    typed_signature character varying(200) NOT NULL,
    signed_at timestamp without time zone NOT NULL,
    submitted_at timestamp without time zone DEFAULT now() NOT NULL,
    retention_until timestamp without time zone DEFAULT (CURRENT_TIMESTAMP + '6 years'::interval) NOT NULL
);


--
-- Name: cmmc_assessment_snapshots_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cmmc_assessment_snapshots_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cmmc_assessment_snapshots_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cmmc_assessment_snapshots_id_seq OWNED BY public.cmmc_assessment_snapshots.id;


--
-- Name: cmmc_assessments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cmmc_assessments (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    customer_id integer,
...
--
-- Name: cmmc_assessments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cmmc_assessments_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cmmc_assessments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cmmc_assessments_id_seq OWNED BY public.cmmc_assessments.id;


--
-- Name: cmmc_report_exports; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cmmc_report_exports (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    assessment_id integer NOT NULL,
    ...
    docx_artifact_key text,
    pdf_sha256 character varying(64),
    docx_sha256 character varying(64),
    pdf_size integer,
    docx_size integer
);
...
--
-- Name: cmmc_report_exports_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cmmc_report_exports_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cmmc_report_exports_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cmmc_report_exports_id_seq OWNED BY public.cmmc_report_exports.id;
...
CREATE TABLE public.commerce_products (
    ...
    mission_id integer,
    post_purchase_sequence_id integer,
...
--
-- Name: commercial_research_opportunities; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commercial_research_opportunities (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    ...
    evidence_confidence character varying(16) DEFAULT 'low'::character varying NOT NULL,
    evidence_state character varying(24) DEFAULT 'unverified'::character varying NOT NULL,
    assumptions jsonb DEFAULT '[]'::jsonb NOT NULL,
    unknowns jsonb DEFAULT '[]'::jsonb NOT NULL,
    risks jsonb DEFAULT '[]'::jsonb NOT NULL,
    kill_criterion text NOT NULL,
    maturity character varying(32) DEFAULT 'concept-ready'::character varying NOT NULL,
    lifecycle_status character varying(24) DEFAULT 'active'::character varying NOT NULL,
    next_test jsonb NOT NULL,
    score_inputs jsonb NOT NULL,
    score_result jsonb NOT NULL,
    validation_evidence jsonb,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT chk_commercial_research_evidence_confidence CHECK (((evidence_confidence)::text = ANY ((ARRAY['low'::character varying, 'medium'::character varying, 'high'::character varying])::text[]))),
    CONSTRAINT chk_commercial_research_evidence_state CHECK (((evidence_state)::text = ANY ((ARRAY['unverified'::character varying, 'incomplete'::character varying, 'mixed'::character varying, 'supported'::character varying, 'contradictory'::character varying, 'verified'::character varying])::text[]))),
    CONSTRAINT chk_commercial_research_json_shapes CHECK (((jsonb_typeof(assumptions) = 'array'::text) AND (jsonb_typeof(unknowns) = 'array'::text) AND (jsonb_typeof(risks) = 'array'::text) AND (jsonb_typeof(next_test) = 'object'::text) AND (jsonb_typeof(score_inputs) = 'object'::text) AND (jsonb_typeof(score_result) = 'object'::text) AND ((validation_evidence IS NULL) OR (jsonb_typeof(validation_evidence) = 'object'::text)))),
    CONSTRAINT chk_commercial_research_lifecycle_status CHECK (((lifecycle_status)::text = ANY ((ARRAY['active'::character varying, 'parked'::character varying, 'rejected'::character varying, 'archived'::character varying])::text[]))),
    CONSTRAINT chk_commercial_research_list_items CHECK (((jsonb_array_length(assumptions) <= 20) AND (jsonb_array_length(unknowns) <= 20) AND (jsonb_array_length(risks) <= 20) AND (NOT jsonb_path_exists(assumptions, '$[*]?((@.type() != "string" || @ like_regex "^[[:space:]]*$") || @ like_regex "^.{255}.{246}" flag "s")'::jsonpath)) AND (NOT jsonb_path_exists(unknowns, '$[*]?((@.type() != "string" || @ like_regex "^[[:space:]]*$") || @ like_regex "^.{255}.{246}" flag "s")'::jsonpath)) AND (NOT jsonb_path_exists(risks, '$[*]?((@.type() != "string" || @ like_regex "^[[:space:]]*$") || @ like_regex "^.{255}.{246}" flag "s")'::jsonpath)))),
    CONSTRAINT chk_commercial_research_maturity CHECK (((maturity)::text = ANY ((ARRAY['concept-ready'::character varying, 'sales-ready'::character varying, 'pilot-ready'::character varying, 'fulfillment-ready'::character varying, 'revenue-validated'::character varying])::text[]))),
    CONSTRAINT chk_commercial_research_next_test CHECK ((((next_test ?& ARRAY['type'::text, 'description'::text, 'successCriterion'::text]) AND ((next_test ->> 'type'::text) = ANY (ARRAY['buyer_interview'::text, 'manual_assessment'::text, 'landing_page'::text, 'prototype'::text, 'paid_pilot'::text, 'other'::text])) AND (NULLIF(btrim((next_test ->> 'description'::text)), ''::text) IS NOT NULL) AND (NULLIF(btrim((next_test ->> 'successCriterion'::text)), ''::text) IS NOT NULL)) IS TRUE)),
    CONSTRAINT chk_commercial_research_revenue_validation CHECK ((((maturity)::text <> 'revenue-validated'::text) OR (((evidence_state)::text = 'verified'::text) AND (validation_evidence IS NOT NULL)))),
    CONSTRAINT chk_commercial_research_score_input_keys CHECK ((score_inputs ?& ARRAY['painUrgency'::text, 'buyerAccess'::text, 'willingnessToPay'::text, 'visionClawAdvantage'::text, 'evidenceStrength'::text, 'speedToFirstSale'::text, 'repeatability'::text, 'deliveryConfidence'::text, 'buildCost'::text, 'fulfillmentCost'::text, 'legalSafetyRisk'::text, 'integrationDependence'::text, 'supportBurden'::text])),
    CONSTRAINT chk_commercial_research_score_inputs CHECK (((jsonb_typeof((score_inputs -> 'painUrgency'::text)) = 'number'::text) AND ((((score_inputs ->> 'painUrgency'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'painUrgency'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'painUrgency'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'buyerAccess'::text)) = 'number'::text) AND ((((score_inputs ->> 'buyerAccess'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'buyerAccess'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'buyerAccess'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'willingnessToPay'::text)) = 'number'::text) AND ((((score_inputs ->> 'willingnessToPay'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'willingnessToPay'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'willingnessToPay'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'visionClawAdvantage'::text)) = 'number'::text) AND ((((score_inputs ->> 'visionClawAdvantage'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'visionClawAdvantage'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'visionClawAdvantage'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'evidenceStrength'::text)) = 'number'::text) AND ((((score_inputs ->> 'evidenceStrength'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'evidenceStrength'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'evidenceStrength'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'speedToFirstSale'::text)) = 'number'::text) AND ((((score_inputs ->> 'speedToFirstSale'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'speedToFirstSale'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'speedToFirstSale'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'repeatability'::text)) = 'number'::text) AND ((((score_inputs ->> 'repeatability'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'repeatability'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'repeatability'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'deliveryConfidence'::text)) = 'number'::text) AND ((((score_inputs ->> 'deliveryConfidence'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'deliveryConfidence'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'deliveryConfidence'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'buildCost'::text)) = 'number'::text) AND ((((score_inputs ->> 'buildCost'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'buildCost'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'buildCost'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'fulfillmentCost'::text)) = 'number'::text) AND ((((score_inputs ->> 'fulfillmentCost'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'fulfillmentCost'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'fulfillmentCost'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'legalSafetyRisk'::text)) = 'number'::text) AND ((((score_inputs ->> 'legalSafetyRisk'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'legalSafetyRisk'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'legalSafetyRisk'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'integrationDependence'::text)) = 'number'::text) AND ((((score_inputs ->> 'integrationDependence'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'integrationDependence'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'integrationDependence'::text))::numeric, (1)::numeric) = (0)::numeric) AND (jsonb_typeof((score_inputs -> 'supportBurden'::text)) = 'number'::text) AND ((((score_inputs ->> 'supportBurden'::text))::numeric >= (0)::numeric) AND (((score_inputs ->> 'supportBurden'::text))::numeric <= (5)::numeric)) AND (mod(((score_inputs ->> 'supportBurden'::text))::numeric, (1)::numeric) = (0)::numeric))),
    CONSTRAINT chk_commercial_research_score_result CHECK ((((score_result ->> 'rubricVersion'::text) = 'commercial-opportunity-v1'::text) AND (jsonb_typeof((score_result -> 'positiveTotal'::text)) = 'number'::text) AND (jsonb_typeof((score_result -> 'riskTotal'::text)) = 'number'::text) AND (jsonb_typeof((score_result -> 'opportunityScore'::text)) = 'number'::text) AND (((score_result ->> 'maxPositive'::text))::numeric = (40)::numeric) AND (((score_result ->> 'maxRisk'::text))::numeric = (25)::numeric) AND (((score_result ->> 'positiveTotal'::text))::numeric = (((((((((score_inputs ->> 'painUrgency'::text))::numeric + ((score_inputs ->> 'buyerAccess'::text))::numeric) + ((score_inputs ->> 'willingnessToPay'::text))::numeric) + ((score_inputs ->> 'visionClawAdvantage'::text))::numeric) + ((score_inputs ->> 'evidenceStrength'::text))::numeric) + ((score_inputs ->> 'speedToFirstSale'::text))::numeric) + ((score_inputs ->> 'repeatability'::text))::numeric) + ((score_inputs ->> 'deliveryConfidence'::text))::numeric)) AND (((score_result ->> 'riskTotal'::text))::numeric = ((((((score_inputs ->> 'buildCost'::text))::numeric + ((score_inputs ->> 'fulfillmentCost'::text))::numeric) + ((score_inputs ->> 'legalSafetyRisk'::text))::numeric) + ((score_inputs ->> 'integrationDependence'::text))::numeric) + ((score_inputs ->> 'supportBurden'::text))::numeric)) AND (((score_result ->> 'opportunityScore'::text))::numeric = GREATEST((0)::numeric, LEAST((100)::numeric, round((((((score_result ->> 'positiveTotal'::text))::numeric / (40)::numeric) * (100)::numeric) - ((((score_result ->> 'riskTotal'::text))::numeric / (25)::numeric) * (50)::numeric)))))))),
    CONSTRAINT chk_commercial_research_score_result_keys CHECK ((score_result ?& ARRAY['rubricVersion'::text, 'positiveTotal'::text, 'riskTotal'::text, 'opportunityScore'::text, 'maxPositive'::text, 'maxRisk'::text])),
    CONSTRAINT chk_commercial_research_score_result_value_types CHECK ((((jsonb_typeof((score_result -> 'rubricVersion'::text)) = 'string'::text) AND (jsonb_typeof((score_result -> 'positiveTotal'::text)) = 'number'::text) AND (jsonb_typeof((score_result -> 'riskTotal'::text)) = 'number'::text) AND (jsonb_typeof((score_result -> 'opportunityScore'::text)) = 'number'::text) AND (jsonb_typeof((score_result -> 'maxPositive'::text)) = 'number'::text) AND (jsonb_typeof((score_result -> 'maxRisk'::text)) = 'number'::text)) IS TRUE)),
    CONSTRAINT chk_commercial_research_validation_evidence CHECK ((((validation_evidence IS NULL) OR ((validation_evidence ?& ARRAY['type'::text, 'reference'::text, 'observedAt'::text]) AND (jsonb_typeof((validation_evidence -> 'type'::text)) = 'string'::text) AND (jsonb_typeof((validation_evidence -> 'reference'::text)) = 'string'::text) AND (jsonb_typeof((validation_evidence -> 'observedAt'::text)) = 'string'::text) AND ((validation_evidence ->> 'type'::text) = ANY (ARRAY['payment'::text, 'signed_pilot'::text, 'buyer_commitment'::text])) AND (NULLIF(btrim((validation_evidence ->> 'reference'::text)), ''::text) IS NOT NULL) AND ((validation_evidence ->> 'observedAt'::text) ~ '^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}(\.[0-9]+)?Z$'::text))) IS TRUE))
);


--
-- Name: commercial_research_opportunities_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commercial_research_opportunities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: commercial_research_opportunities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commercial_research_opportunities_id_seq OWNED BY public.commercial_research_opportunities.id;
...
--
-- Name: delegation_supervisor_receipts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delegation_supervisor_receipts (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: delegation_supervisor_receipts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.delegation_supervisor_receipts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: delegation_supervisor_receipts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.delegation_supervisor_receipts_id_seq OWNED BY public.delegation_supervisor_receipts.id;
...
--
-- Name: deliverable_exemplars; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.deliverable_exemplars (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    ...
    source text DEFAULT 'auto_grade'::text NOT NULL,
    metadata jsonb,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: deliverable_exemplars_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.deliverable_exemplars_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: deliverable_exemplars_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.deliverable_exemplars_id_seq OWNED BY public.deliverable_exemplars.id;


--
-- Name: deliverable_grade_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.deliverable_grade_events (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    format text NOT NULL,
    score integer NOT NULL,
...
--
-- Name: deliverable_grade_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.deliverable_grade_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: deliverable_grade_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.deliverable_grade_events_id_seq OWNED BY public.deliverable_grade_events.id;
...
--
-- Name: derived_api_recipes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.derived_api_recipes (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    name text NOT NULL,
    description text,
...
--
-- Name: derived_api_recipes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.derived_api_recipes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: derived_api_recipes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.derived_api_recipes_id_seq OWNED BY public.derived_api_recipes.id;


--
-- Name: dfy_intake_forms; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.dfy_intake_forms (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    token text NOT NULL,
    order_id text,
...
--
-- Name: dfy_intake_forms_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.dfy_intake_forms_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: dfy_intake_forms_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.dfy_intake_forms_id_seq OWNED BY public.dfy_intake_forms.id;
...
--
-- Name: episode_playbooks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.episode_playbooks (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    run_type text NOT NULL,
    goal text NOT NULL,
    goal_embedding public.vector(1536),
...
--
-- Name: episode_playbooks_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.episode_playbooks_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: episode_playbooks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.episode_playbooks_id_seq OWNED BY public.episode_playbooks.id;
...
--
-- Name: falsified_routes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.falsified_routes (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: falsified_routes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.falsified_routes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: falsified_routes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.falsified_routes_id_seq OWNED BY public.falsified_routes.id;
...
--
-- Name: harness_manifests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.harness_manifests (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: harness_manifests_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.harness_manifests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: harness_manifests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.harness_manifests_id_seq OWNED BY public.harness_manifests.id;
...
--
-- Name: hvac_missed_call_workspaces; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.hvac_missed_call_workspaces (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    idempotency_key character varying(128) NOT NULL,
    prospect_name character varying(160) NOT NULL,
    company_name character varying(160) NOT NULL,
    trade character varying(32) DEFAULT 'hvac'::character varying NOT NULL,
    intake jsonb DEFAULT '{}'::jsonb NOT NULL,
    assumptions jsonb DEFAULT '{}'::jsonb NOT NULL,
    estimate jsonb DEFAULT '{}'::jsonb NOT NULL,
    status character varying(32) DEFAULT 'discovery'::character varying NOT NULL,
...
--
-- Name: hvac_missed_call_workspaces_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.hvac_missed_call_workspaces_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: hvac_missed_call_workspaces_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.hvac_missed_call_workspaces_id_seq OWNED BY public.hvac_missed_call_workspaces.id;
...
--
-- Name: loop_graph_edges; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loop_graph_edges (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    ...
    evidence jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_loop_edges_relation CHECK ((relation = ANY (ARRAY['succeeded_by'::text, 'derived_from'::text, 'replayed_against'::text, 'crossover_of'::text])))
);


--
-- Name: loop_graph_edges_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.loop_graph_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: loop_graph_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.loop_graph_edges_id_seq OWNED BY public.loop_graph_edges.id;


--
-- Name: loop_outcome_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loop_outcome_events (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    safety_evaluated boolean DEFAULT false NOT NULL,
    CONSTRAINT chk_loop_outcomes_cost CHECK ((cost_usd >= (0)::double precision)),
    CONSTRAINT chk_loop_outcomes_exploration CHECK (((exploration_value IS NULL) OR ((exploration_value >= (0)::double precision) AND (exploration_value <= (1)::double precision)))),
    CONSTRAINT chk_loop_outcomes_latency CHECK ((latency_ms >= 0)),
    CONSTRAINT chk_loop_outcomes_mode CHECK ((mode = ANY (ARRAY['online'::text, 'replay'::text, 'shadow'::text, 'report_only'::text]))),
    CONSTRAINT chk_loop_outcomes_persisted CHECK (((persisted_quality IS NULL) OR ((persisted_quality >= (0)::double precision) AND (persisted_quality <= (1)::double precision)))),
    CONSTRAINT chk_loop_outcomes_quality CHECK (((quality >= (0)::double precision) AND (quality <= (1)::double precision)))
);


--
-- Name: loop_outcome_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.loop_outcome_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: loop_outcome_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.loop_outcome_events_id_seq OWNED BY public.loop_outcome_events.id;
...
--
-- Name: memory_derivations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.memory_derivations (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    ...
    solely_derived boolean DEFAULT false NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL
);


--
-- Name: memory_derivations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.memory_derivations_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: memory_derivations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.memory_derivations_id_seq OWNED BY public.memory_derivations.id;
...
--
-- Name: memory_erasure_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.memory_erasure_requests (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    request_key text NOT NULL,
    mode text DEFAULT 'explicit'::text NOT NULL,
    status text DEFAULT 'pending'::text NOT NULL,
    reason_code text,
...
--
-- Name: memory_erasure_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.memory_erasure_requests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: memory_erasure_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.memory_erasure_requests_id_seq OWNED BY public.memory_erasure_requests.id;


--
-- Name: memory_forgetting_scheduler_state; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.memory_forgetting_scheduler_state (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    last_scanned_at timestamp without time zone,
    next_source_offset integer DEFAULT 0 NOT NULL,
    updated_at timestamp without time zone DEFAULT now() NOT NULL,
    source_cursors jsonb DEFAULT '{}'::jsonb NOT NULL,
    lease_token text,
...
--
-- Name: memory_forgetting_scheduler_state_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.memory_forgetting_scheduler_state_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: memory_forgetting_scheduler_state_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.memory_forgetting_scheduler_state_id_seq OWNED BY public.memory_forgetting_scheduler_state.id;
...
--
-- Name: memory_lifecycle_action_claims; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.memory_lifecycle_action_claims (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: memory_lifecycle_action_claims_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.memory_lifecycle_action_claims_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: memory_lifecycle_action_claims_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.memory_lifecycle_action_claims_id_seq OWNED BY public.memory_lifecycle_action_claims.id;


--
-- Name: memory_lifecycle_audits; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.memory_lifecycle_audits (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    action_key text NOT NULL,
    source text NOT NULL,
    ...
    action text NOT NULL,
    mode text DEFAULT 'report_only'::text NOT NULL,
    outcome text DEFAULT 'recorded'::text NOT NULL,
    reason_code text,
    request_key text,
    failure_code text,
...
--
-- Name: memory_lifecycle_audits_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.memory_lifecycle_audits_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: memory_lifecycle_audits_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.memory_lifecycle_audits_id_seq OWNED BY public.memory_lifecycle_audits.id;
...
--
-- Name: memory_retention_policies; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: memory_retention_policies_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.memory_retention_policies_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: memory_retention_policies_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.memory_retention_policies_id_seq OWNED BY public.memory_retention_policies.id;
...
CREATE TABLE public.memory_tombstones (
    ...
    request_key text NOT NULL,
    reason_code text DEFAULT 'explicit_erasure'::text NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL
);
...
--
-- Name: mission_evidence; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: mission_evidence_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: mission_evidence_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: mission_experiments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: mission_experiments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: mission_experiments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.plans (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT plans_status_check CHECK ((status = ANY (ARRAY['awaiting_approval'::text, 'approved'::text, 'rejected'::text, 'revising'::text, 'revised'::text, 'executing'::text, 'completed'::text, 'failed'::text, 'expired'::text, 'publish_required'::text, 'handoff_pending'::text])))
);
...
--
-- Name: project_compasses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.project_compasses (
    id integer NOT NULL,
...
--
-- Name: project_compasses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.project_compasses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: project_compasses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.project_compasses_id_seq OWNED BY public.project_compasses.id;
...
--
-- Name: repair_handoff_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.repair_handoff_requests (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: repair_handoff_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.repair_handoff_requests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: repair_handoff_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.repair_handoff_requests_id_seq OWNED BY public.repair_handoff_requests.id;
...
--
-- Name: research_evidence_triples; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.research_evidence_triples (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    subject text NOT NULL,
    predicate text NOT NULL,
...
--
-- Name: research_evidence_triples_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.research_evidence_triples_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: research_evidence_triples_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.research_evidence_triples_id_seq OWNED BY public.research_evidence_triples.id;
...
--
-- Name: revenue_missions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: revenue_missions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: revenue_missions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: revenue_orchestrator_mission_links; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.revenue_orchestrator_mission_links (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: revenue_orchestrator_mission_links_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.revenue_orchestrator_mission_links_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: revenue_orchestrator_mission_links_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.revenue_orchestrator_mission_links_id_seq OWNED BY public.revenue_orchestrator_mission_links.id;
...
--
-- Name: skill_optimization_candidates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.skill_optimization_candidates (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    skill_id integer,
...
--
-- Name: skill_optimization_candidates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.skill_optimization_candidates_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: skill_optimization_candidates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.skill_optimization_candidates_id_seq OWNED BY public.skill_optimization_candidates.id;


--
-- Name: skill_optimization_versions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.skill_optimization_versions (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: skill_optimization_versions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.skill_optimization_versions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: skill_optimization_versions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.skill_optimization_versions_id_seq OWNED BY public.skill_optimization_versions.id;
...
--
-- Name: synergy_trials; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.synergy_trials (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    idempotency_key character varying(80) NOT NULL,
    trial_name character varying(120) NOT NULL,
    task_label character varying(200) NOT NULL,
    participant_alias character varying(120) NOT NULL,
    rubric_version character varying(40) NOT NULL,
...
--
-- Name: synergy_trials_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.synergy_trials_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: synergy_trials_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.synergy_trials_id_seq OWNED BY public.synergy_trials.id;
...
--
-- Name: tool_mispicks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tool_mispicks (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    persona_id integer,
    conversation_id integer,
    failed_tool text NOT NULL,
    succeeded_tool text NOT NULL,
    failed_error text,
    created_at timestamp without time zone DEFAULT now() NOT NULL
);
...
--
-- Name: tool_mispicks_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tool_mispicks_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: tool_mispicks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tool_mispicks_id_seq OWNED BY public.tool_mispicks.id;
...
--
-- Name: typesafe_fact_prefilter_observations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.typesafe_fact_prefilter_observations (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    source_message_id integer NOT NULL,
    conversation_id integer NOT NULL,
    version text DEFAULT 'jev-session-fact-prefilter-v1'::text NOT NULL,
    mode text NOT NULL,
    status text DEFAULT 'claimed'::text NOT NULL,
...
--
-- Name: typesafe_fact_prefilter_observations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.typesafe_fact_prefilter_observations_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: typesafe_fact_prefilter_observations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.typesafe_fact_prefilter_observations_id_seq OWNED BY public.typesafe_fact_prefilter_observations.id;
...
--
-- Name: web_collection_runs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: web_collection_runs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.web_collection_runs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: web_collection_runs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.web_collection_runs_id_seq OWNED BY public.web_collection_runs.id;


--
-- Name: web_domain_cooldowns; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.web_domain_cooldowns (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
...
--
-- Name: web_domain_cooldowns_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.web_domain_cooldowns_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: web_domain_cooldowns_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.web_domain_cooldowns_id_seq OWNED BY public.web_domain_cooldowns.id;


--
-- Name: web_domain_usage_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.web_domain_usage_events (
    id integer NOT NULL,
    tenant_id integer NOT NULL,
    hostname text NOT NULL,
...
--
-- Name: web_domain_usage_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.web_domain_usage_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: web_domain_usage_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.web_domain_usage_events_id_seq OWNED BY public.web_domain_usage_events.id;
...
--
-- Name: webhook_trigger_events; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.webhook_trigger_events (
    ...
    response_preview text DEFAULT ''::text,
...
--
-- Name: webhook_trigger_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.webhook_trigger_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: webhook_trigger_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.webhook_trigger_events_id_seq OWNED BY public.webhook_trigger_events.id;
...
--
-- Name: account_erasure_receipts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.account_erasure_receipts ALTER COLUMN id SET DEFAULT nextval('public.account_erasure_receipts_id_seq'::regclass);
...
--
-- Name: agent_capital id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: agent_recovery_manifests id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_recovery_manifests ALTER COLUMN id SET DEFAULT nextval('public.agent_recovery_manifests_id_seq'::regclass);
...
--
-- Name: artifact_records id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.artifact_records ALTER COLUMN id SET DEFAULT nextval('public.artifact_records_id_seq'::regclass);
...
--
-- Name: cmmc_assessment_invitations id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_invitations ALTER COLUMN id SET DEFAULT nextval('public.cmmc_assessment_invitations_id_seq'::regclass);


--
-- Name: cmmc_assessment_snapshots id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_snapshots ALTER COLUMN id SET DEFAULT nextval('public.cmmc_assessment_snapshots_id_seq'::regclass);


--
-- Name: cmmc_assessments id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: cmmc_report_exports id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_report_exports ALTER COLUMN id SET DEFAULT nextval('public.cmmc_report_exports_id_seq'::regclass);
...
--
-- Name: commercial_research_opportunities id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commercial_research_opportunities ALTER COLUMN id SET DEFAULT nextval('public.commercial_research_opportunities_id_seq'::regclass);
...
--
-- Name: delegation_supervisor_receipts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegation_supervisor_receipts ALTER COLUMN id SET DEFAULT nextval('public.delegation_supervisor_receipts_id_seq'::regclass);
...
--
-- Name: deliverable_exemplars id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deliverable_exemplars ALTER COLUMN id SET DEFAULT nextval('public.deliverable_exemplars_id_seq'::regclass);


--
-- Name: deliverable_grade_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deliverable_grade_events ALTER COLUMN id SET DEFAULT nextval('public.deliverable_grade_events_id_seq'::regclass);
...
--
-- Name: derived_api_recipes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.derived_api_recipes ALTER COLUMN id SET DEFAULT nextval('public.derived_api_recipes_id_seq'::regclass);


--
-- Name: dfy_intake_forms id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dfy_intake_forms ALTER COLUMN id SET DEFAULT nextval('public.dfy_intake_forms_id_seq'::regclass);
...
--
-- Name: episode_playbooks id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.episode_playbooks ALTER COLUMN id SET DEFAULT nextval('public.episode_playbooks_id_seq'::regclass);
...
--
-- Name: falsified_routes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.falsified_routes ALTER COLUMN id SET DEFAULT nextval('public.falsified_routes_id_seq'::regclass);
...
--
-- Name: harness_manifests id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.harness_manifests ALTER COLUMN id SET DEFAULT nextval('public.harness_manifests_id_seq'::regclass);
...
--
-- Name: hvac_missed_call_workspaces id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hvac_missed_call_workspaces ALTER COLUMN id SET DEFAULT nextval('public.hvac_missed_call_workspaces_id_seq'::regclass);
...
--
-- Name: loop_graph_edges id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loop_graph_edges ALTER COLUMN id SET DEFAULT nextval('public.loop_graph_edges_id_seq'::regclass);


--
-- Name: loop_outcome_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loop_outcome_events ALTER COLUMN id SET DEFAULT nextval('public.loop_outcome_events_id_seq'::regclass);
...
--
-- Name: memory_derivations id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_derivations ALTER COLUMN id SET DEFAULT nextval('public.memory_derivations_id_seq'::regclass);
...
--
-- Name: memory_erasure_requests id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_erasure_requests ALTER COLUMN id SET DEFAULT nextval('public.memory_erasure_requests_id_seq'::regclass);


--
-- Name: memory_forgetting_scheduler_state id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_forgetting_scheduler_state ALTER COLUMN id SET DEFAULT nextval('public.memory_forgetting_scheduler_state_id_seq'::regclass);
...
--
-- Name: memory_lifecycle_action_claims id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_lifecycle_action_claims ALTER COLUMN id SET DEFAULT nextval('public.memory_lifecycle_action_claims_id_seq'::regclass);


--
-- Name: memory_lifecycle_audits id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_lifecycle_audits ALTER COLUMN id SET DEFAULT nextval('public.memory_lifecycle_audits_id_seq'::regclass);
...
--
-- Name: memory_retention_policies id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_retention_policies ALTER COLUMN id SET DEFAULT nextval('public.memory_retention_policies_id_seq'::regclass);
...
--
-- Name: mission_evidence id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: mission_experiments id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: project_compasses id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_compasses ALTER COLUMN id SET DEFAULT nextval('public.project_compasses_id_seq'::regclass);
...
--
-- Name: repair_handoff_requests id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repair_handoff_requests ALTER COLUMN id SET DEFAULT nextval('public.repair_handoff_requests_id_seq'::regclass);
...
--
-- Name: research_evidence_triples id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.research_evidence_triples ALTER COLUMN id SET DEFAULT nextval('public.research_evidence_triples_id_seq'::regclass);
...
--
-- Name: revenue_missions id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: revenue_orchestrator_mission_links id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_orchestrator_mission_links ALTER COLUMN id SET DEFAULT nextval('public.revenue_orchestrator_mission_links_id_seq'::regclass);
...
--
-- Name: skill_optimization_candidates id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_candidates ALTER COLUMN id SET DEFAULT nextval('public.skill_optimization_candidates_id_seq'::regclass);


--
-- Name: skill_optimization_versions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_versions ALTER COLUMN id SET DEFAULT nextval('public.skill_optimization_versions_id_seq'::regclass);
...
--
-- Name: synergy_trials id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.synergy_trials ALTER COLUMN id SET DEFAULT nextval('public.synergy_trials_id_seq'::regclass);
...
--
-- Name: tool_mispicks id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tool_mispicks ALTER COLUMN id SET DEFAULT nextval('public.tool_mispicks_id_seq'::regclass);
...
--
-- Name: typesafe_fact_prefilter_observations id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.typesafe_fact_prefilter_observations ALTER COLUMN id SET DEFAULT nextval('public.typesafe_fact_prefilter_observations_id_seq'::regclass);
...
--
-- Name: web_collection_runs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_collection_runs ALTER COLUMN id SET DEFAULT nextval('public.web_collection_runs_id_seq'::regclass);


--
-- Name: web_domain_cooldowns id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_domain_cooldowns ALTER COLUMN id SET DEFAULT nextval('public.web_domain_cooldowns_id_seq'::regclass);


--
-- Name: web_domain_usage_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_domain_usage_events ALTER COLUMN id SET DEFAULT nextval('public.web_domain_usage_events_id_seq'::regclass);


--
-- Name: webhook_trigger_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.webhook_trigger_events ALTER COLUMN id SET DEFAULT nextval('public.webhook_trigger_events_id_seq'::regclass);
...
--
-- Name: account_erasure_receipts account_erasure_receipts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.account_erasure_receipts
    ADD CONSTRAINT account_erasure_receipts_pkey PRIMARY KEY (id);
...
--
-- Name: agent_capital agent_capital_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agent_capital agent_capital_tenant_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agent_recovery_manifests agent_recovery_manifests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_recovery_manifests
    ADD CONSTRAINT agent_recovery_manifests_pkey PRIMARY KEY (id);
...
--
-- Name: agent_runs agent_runs_tenant_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: artifact_records artifact_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.artifact_records
    ADD CONSTRAINT artifact_records_pkey PRIMARY KEY (id);
...
--
-- Name: cmmc_assessment_invitations cmmc_assessment_invitations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_invitations
    ADD CONSTRAINT cmmc_assessment_invitations_pkey PRIMARY KEY (id);


--
-- Name: cmmc_assessment_snapshots cmmc_assessment_snapshots_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_snapshots
    ADD CONSTRAINT cmmc_assessment_snapshots_pkey PRIMARY KEY (id);


--
-- Name: cmmc_assessments cmmc_assessments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessments
    ADD CONSTRAINT cmmc_assessments_pkey PRIMARY KEY (id);


--
-- Name: cmmc_report_exports cmmc_report_exports_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_report_exports
    ADD CONSTRAINT cmmc_report_exports_pkey PRIMARY KEY (id);
...
--
-- Name: commercial_research_opportunities commercial_research_opportunities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commercial_research_opportunities
    ADD CONSTRAINT commercial_research_opportunities_pkey PRIMARY KEY (id);
...
--
-- Name: delegation_supervisor_receipts delegation_supervisor_receipts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegation_supervisor_receipts
    ADD CONSTRAINT delegation_supervisor_receipts_pkey PRIMARY KEY (id);
...
--
-- Name: deliverable_exemplars deliverable_exemplars_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deliverable_exemplars
    ADD CONSTRAINT deliverable_exemplars_pkey PRIMARY KEY (id);


--
-- Name: deliverable_grade_events deliverable_grade_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deliverable_grade_events
    ADD CONSTRAINT deliverable_grade_events_pkey PRIMARY KEY (id);
...
--
-- Name: derived_api_recipes derived_api_recipes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.derived_api_recipes
    ADD CONSTRAINT derived_api_recipes_pkey PRIMARY KEY (id);


--
-- Name: dfy_intake_forms dfy_intake_forms_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dfy_intake_forms
    ADD CONSTRAINT dfy_intake_forms_pkey PRIMARY KEY (id);
...
--
-- Name: episode_playbooks episode_playbooks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.episode_playbooks
    ADD CONSTRAINT episode_playbooks_pkey PRIMARY KEY (id);
...
--
-- Name: falsified_routes falsified_routes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.falsified_routes
    ADD CONSTRAINT falsified_routes_pkey PRIMARY KEY (id);
...
--
-- Name: harness_manifests harness_manifests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.harness_manifests
    ADD CONSTRAINT harness_manifests_pkey PRIMARY KEY (id);
...
--
-- Name: hvac_missed_call_workspaces hvac_missed_call_workspaces_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hvac_missed_call_workspaces
    ADD CONSTRAINT hvac_missed_call_workspaces_pkey PRIMARY KEY (id);
...
--
-- Name: loop_graph_edges loop_graph_edges_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loop_graph_edges
    ADD CONSTRAINT loop_graph_edges_pkey PRIMARY KEY (id);


--
-- Name: loop_outcome_events loop_outcome_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loop_outcome_events
    ADD CONSTRAINT loop_outcome_events_pkey PRIMARY KEY (id);
...
--
-- Name: memory_derivations memory_derivations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_derivations
...
--
-- Name: memory_erasure_requests memory_erasure_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_erasure_requests
    ADD CONSTRAINT memory_erasure_requests_pkey PRIMARY KEY (id);


--
-- Name: memory_forgetting_scheduler_state memory_forgetting_scheduler_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_forgetting_scheduler_state
    ADD CONSTRAINT memory_forgetting_scheduler_state_pkey PRIMARY KEY (id);
...
--
-- Name: memory_lifecycle_action_claims memory_lifecycle_action_claims_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_lifecycle_action_claims
    ADD CONSTRAINT memory_lifecycle_action_claims_pkey PRIMARY KEY (id);


--
-- Name: memory_lifecycle_audits memory_lifecycle_audits_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_lifecycle_audits
    ADD CONSTRAINT memory_lifecycle_audits_pkey PRIMARY KEY (id);
...
--
-- Name: memory_retention_policies memory_retention_policies_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_retention_policies
    ADD CONSTRAINT memory_retention_policies_pkey PRIMARY KEY (id);
...
--
-- Name: mission_evidence mission_evidence_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mission_experiments mission_experiments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: project_compasses project_compasses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_compasses
    ADD CONSTRAINT project_compasses_pkey PRIMARY KEY (id);
...
--
-- Name: repair_handoff_requests repair_handoff_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repair_handoff_requests
    ADD CONSTRAINT repair_handoff_requests_pkey PRIMARY KEY (id);
...
--
-- Name: research_evidence_triples research_evidence_triples_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.research_evidence_triples
    ADD CONSTRAINT research_evidence_triples_pkey PRIMARY KEY (id);
...
--
-- Name: revenue_missions revenue_missions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: revenue_missions revenue_missions_tenant_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_missions
    ADD CONSTRAINT revenue_missions_tenant_id_unique UNIQUE (tenant_id, id);


--
-- Name: revenue_orchestrator_mission_links revenue_orchestrator_links_tenant_key_run_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_orchestrator_mission_links
    ADD CONSTRAINT revenue_orchestrator_links_tenant_key_run_unique UNIQUE (tenant_id, api_key_id, source_run_id);


--
-- Name: revenue_orchestrator_mission_links revenue_orchestrator_mission_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_orchestrator_mission_links
    ADD CONSTRAINT revenue_orchestrator_mission_links_pkey PRIMARY KEY (id);
...
--
-- Name: skill_optimization_candidates skill_optimization_candidates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_candidates
    ADD CONSTRAINT skill_optimization_candidates_pkey PRIMARY KEY (id);


--
-- Name: skill_optimization_versions skill_optimization_versions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_versions
    ADD CONSTRAINT skill_optimization_versions_pkey PRIMARY KEY (id);
...
--
-- Name: synergy_trials synergy_trials_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.synergy_trials
    ADD CONSTRAINT synergy_trials_pkey PRIMARY KEY (id);
...
--
-- Name: tool_mispicks tool_mispicks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tool_mispicks
    ADD CONSTRAINT tool_mispicks_pkey PRIMARY KEY (id);
...
--
-- Name: typesafe_fact_prefilter_observations typesafe_fact_prefilter_observations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.typesafe_fact_prefilter_observations
    ADD CONSTRAINT typesafe_fact_prefilter_observations_pkey PRIMARY KEY (id);


--
-- Name: harness_manifests uq_harness_manifests_tenant_id; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.harness_manifests
    ADD CONSTRAINT uq_harness_manifests_tenant_id UNIQUE (id, tenant_id);


--
-- Name: harness_manifests uq_harness_manifests_tenant_id_id; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.harness_manifests
    ADD CONSTRAINT uq_harness_manifests_tenant_id_id UNIQUE (tenant_id, id);


--
-- Name: loop_outcome_events uq_loop_outcomes_id_tenant; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loop_outcome_events
    ADD CONSTRAINT uq_loop_outcomes_id_tenant UNIQUE (id, tenant_id);


--
-- Name: projects uq_projects_tenant_id_id_fk; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.projects
    ADD CONSTRAINT uq_projects_tenant_id_id_fk UNIQUE (id, tenant_id);


--
-- Name: skill_optimization_candidates uq_skill_opt_candidates_id_tenant; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_candidates
    ADD CONSTRAINT uq_skill_opt_candidates_id_tenant UNIQUE (id, tenant_id);


--
-- Name: typesafe_fact_prefilter_observations uq_typesafe_fact_prefilter_source; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.typesafe_fact_prefilter_observations
    ADD CONSTRAINT uq_typesafe_fact_prefilter_source UNIQUE (tenant_id, source_message_id, version);


--
-- Name: webhook_triggers uq_webhook_triggers_tenant_id_id; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.webhook_triggers
    ADD CONSTRAINT uq_webhook_triggers_tenant_id_id UNIQUE (tenant_id, id);
...
--
-- Name: web_collection_runs web_collection_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_collection_runs
    ADD CONSTRAINT web_collection_runs_pkey PRIMARY KEY (id);


--
-- Name: web_domain_cooldowns web_domain_cooldowns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_domain_cooldowns
    ADD CONSTRAINT web_domain_cooldowns_pkey PRIMARY KEY (id);


--
-- Name: web_domain_usage_events web_domain_usage_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_domain_usage_events
    ADD CONSTRAINT web_domain_usage_events_pkey PRIMARY KEY (id);
...
--
-- Name: webhook_trigger_events webhook_trigger_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: webhook_triggers webhook_triggers_webhook_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.webhook_triggers
    ADD CONSTRAINT webhook_triggers_webhook_key_key UNIQUE (webhook_key);
...
--
-- Name: ab_runs_tenant_source_key_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ab_runs_tenant_source_key_unique ON public.ab_runs USING btree (tenant_id, source_key);
...
--
-- Name: code_proposals_repair_provenance_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX code_proposals_repair_provenance_unique ON public.code_proposals USING btree (tenant_id, source, source_session_id) WHERE ((source = 'production-repair-handoff'::text) AND (source_session_id IS NOT NULL));
...
--
-- Name: deliverable_exemplars_dedupe_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX deliverable_exemplars_dedupe_idx ON public.deliverable_exemplars USING btree (tenant_id, format, content_sha256);


--
-- Name: deliverable_exemplars_tenant_format_score_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX deliverable_exemplars_tenant_format_score_idx ON public.deliverable_exemplars USING btree (tenant_id, format, score);
...
--
-- Name: delivery_logs_tenant_idempotency_key_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_logs_tenant_idempotency_key_unique ON public.delivery_logs USING btree (tenant_id, idempotency_key) WHERE (idempotency_key IS NOT NULL);
...
--
-- Name: file_storage_cmmc_artifact_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX file_storage_cmmc_artifact_uidx ON public.file_storage USING btree (tenant_id, filename) WHERE (filename ~~ 'cmmc-report-%'::text);


--
-- Name: file_storage_delivery_asset_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX file_storage_delivery_asset_uidx ON public.file_storage USING btree (tenant_id, filename) WHERE (filename ~~ 'delivery-%'::text);


--
-- Name: file_storage_local_state_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX file_storage_local_state_uidx ON public.file_storage USING btree (tenant_id, filename) WHERE (filename ~~ 'local-state-%'::text);


--
-- Name: file_storage_queue_backup_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX file_storage_queue_backup_uidx ON public.file_storage USING btree (tenant_id, filename) WHERE (filename = 'service-review-queue-backup.json'::text);


--
-- Name: idx_account_erasure_receipts_fingerprint; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_account_erasure_receipts_fingerprint ON public.account_erasure_receipts USING btree (tenant_fingerprint);
...
--
-- Name: idx_agent_capital_tenant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_agent_cost_ledger_tenant_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_agent_cost_ledger_tenant_idempotency ON public.agent_cost_ledger USING btree (tenant_id, idempotency_key) WHERE (idempotency_key IS NOT NULL);


--
-- Name: idx_agent_cost_ledger_tenant_mission; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_cost_ledger_tenant_mission ON public.agent_cost_ledger USING btree (tenant_id, mission_id);
...
--
-- Name: idx_agent_recovery_manifests_conversation_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_recovery_manifests_conversation_order ON public.agent_recovery_manifests USING btree (tenant_id, conversation_id, event_index);


--
-- Name: idx_agent_recovery_manifests_run_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_recovery_manifests_run_order ON public.agent_recovery_manifests USING btree (tenant_id, run_id, event_index);


--
-- Name: idx_agent_recovery_manifests_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_recovery_manifests_tenant_created ON public.agent_recovery_manifests USING btree (tenant_id, created_at);


--
-- Name: idx_agent_recovery_manifests_tenant_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_agent_recovery_manifests_tenant_idempotency ON public.agent_recovery_manifests USING btree (tenant_id, idempotency_key);


--
-- Name: idx_agent_recovery_manifests_trace_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_agent_recovery_manifests_trace_order ON public.agent_recovery_manifests USING btree (tenant_id, trace_id, event_index);
...
--
-- Name: idx_artifact_events_artifact_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_artifact_events_artifact_created ON public.artifact_events USING btree (artifact_id, created_at);


--
-- Name: idx_artifact_events_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_artifact_events_tenant_created ON public.artifact_events USING btree (tenant_id, created_at);


--
-- Name: idx_artifact_records_delivery_log; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_artifact_records_delivery_log ON public.artifact_records USING btree (delivery_log_id);


--
-- Name: idx_artifact_records_file_storage; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_artifact_records_file_storage ON public.artifact_records USING btree (file_storage_id);


--
-- Name: idx_artifact_records_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_artifact_records_tenant_created ON public.artifact_records USING btree (tenant_id, created_at);


--
-- Name: idx_artifact_records_tenant_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_artifact_records_tenant_idempotency ON public.artifact_records USING btree (tenant_id, idempotency_key);


--
-- Name: idx_artifact_records_tenant_project; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_artifact_records_tenant_project ON public.artifact_records USING btree (tenant_id, project_id, created_at);


--
-- Name: idx_artifact_records_tenant_scope_revision; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_artifact_records_tenant_scope_revision ON public.artifact_records USING btree (tenant_id, scope_key, logical_name, revision);


--
-- Name: idx_artifact_records_tenant_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_artifact_records_tenant_status ON public.artifact_records USING btree (tenant_id, status, updated_at);
...
--
-- Name: idx_cmmc_assessments_customer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_assessments_customer ON public.cmmc_assessments USING btree (tenant_id, customer_id);


--
-- Name: idx_cmmc_assessments_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_assessments_status ON public.cmmc_assessments USING btree (tenant_id, status);


--
-- Name: idx_cmmc_assessments_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_assessments_tenant ON public.cmmc_assessments USING btree (tenant_id);


--
-- Name: idx_cmmc_exports_tenant_assessment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_exports_tenant_assessment ON public.cmmc_report_exports USING btree (tenant_id, assessment_id);


--
-- Name: idx_cmmc_exports_tenant_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_exports_tenant_status ON public.cmmc_report_exports USING btree (tenant_id, status);


--
-- Name: idx_cmmc_invites_assessment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_invites_assessment ON public.cmmc_assessment_invitations USING btree (tenant_id, assessment_id);


--
-- Name: idx_cmmc_invites_expiry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_invites_expiry ON public.cmmc_assessment_invitations USING btree (expires_at);


--
-- Name: idx_cmmc_snapshots_assessment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_snapshots_assessment ON public.cmmc_assessment_snapshots USING btree (tenant_id, assessment_id);


--
-- Name: idx_cmmc_snapshots_tenant_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cmmc_snapshots_tenant_hash ON public.cmmc_assessment_snapshots USING btree (tenant_id, answer_hash);
...
--
-- Name: idx_commerce_products_sku; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_commerce_products_sku ON public.commerce_products USING btree (tenant_id, sku);


--
-- Name: idx_commerce_products_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commerce_products_tenant ON public.commerce_products USING btree (tenant_id);


--
-- Name: idx_commercial_research_opportunities_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commercial_research_opportunities_tenant ON public.commercial_research_opportunities USING btree (tenant_id);


--
-- Name: idx_commercial_research_opportunities_tenant_maturity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commercial_research_opportunities_tenant_maturity ON public.commercial_research_opportunities USING btree (tenant_id, maturity);


--
-- Name: idx_commercial_research_opportunities_tenant_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commercial_research_opportunities_tenant_status ON public.commercial_research_opportunities USING btree (tenant_id, lifecycle_status);


--
-- Name: idx_commercial_research_opportunities_tenant_updated; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commercial_research_opportunities_tenant_updated ON public.commercial_research_opportunities USING btree (tenant_id, updated_at);
...
--
-- Name: idx_delegation_supervisor_receipts_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_delegation_supervisor_receipts_tenant_created ON public.delegation_supervisor_receipts USING btree (tenant_id, created_at);


--
-- Name: idx_delegation_supervisor_receipts_tenant_delegation; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_delegation_supervisor_receipts_tenant_delegation ON public.delegation_supervisor_receipts USING btree (tenant_id, delegation_id);


--
-- Name: idx_deliverable_grade_events_tenant_format; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_deliverable_grade_events_tenant_format ON public.deliverable_grade_events USING btree (tenant_id, format, created_at);
...
--
-- Name: idx_derived_api_recipes_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_derived_api_recipes_tenant ON public.derived_api_recipes USING btree (tenant_id);


--
-- Name: idx_dfy_intake_forms_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dfy_intake_forms_tenant_created ON public.dfy_intake_forms USING btree (tenant_id, created_at);


--
-- Name: idx_dfy_intake_forms_website; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dfy_intake_forms_website ON public.dfy_intake_forms USING btree (website);
...
--
-- Name: idx_episode_playbooks_tenant_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_episode_playbooks_tenant_type ON public.episode_playbooks USING btree (tenant_id, run_type);


--
-- Name: idx_eval_runs_harness_manifest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_eval_runs_harness_manifest ON public.eval_runs USING btree (tenant_id, harness_manifest_id);
...
--
-- Name: idx_falsified_routes_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_falsified_routes_tenant ON public.falsified_routes USING btree (tenant_id);
...
--
-- Name: idx_harness_manifests_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_harness_manifests_tenant_created ON public.harness_manifests USING btree (tenant_id, created_at);


--
-- Name: idx_harness_manifests_tenant_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_harness_manifests_tenant_hash ON public.harness_manifests USING btree (tenant_id, manifest_hash);
...
--
-- Name: idx_hvac_missed_call_workspaces_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hvac_missed_call_workspaces_tenant ON public.hvac_missed_call_workspaces USING btree (tenant_id);


--
-- Name: idx_hvac_missed_call_workspaces_tenant_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hvac_missed_call_workspaces_tenant_status ON public.hvac_missed_call_workspaces USING btree (tenant_id, status);
...
--
-- Name: idx_knowledge_triples_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_knowledge_triples_tenant ON public.knowledge_triples USING btree (tenant_id);
...
--
-- Name: idx_loop_edges_tenant_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_loop_edges_tenant_source ON public.loop_graph_edges USING btree (tenant_id, source_event_id);


--
-- Name: idx_loop_edges_tenant_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_loop_edges_tenant_target ON public.loop_graph_edges USING btree (tenant_id, target_event_id);


--
-- Name: idx_loop_outcomes_tenant_loop_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_loop_outcomes_tenant_loop_time ON public.loop_outcome_events USING btree (tenant_id, loop_kind, occurred_at);


--
-- Name: idx_loop_outcomes_tenant_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_loop_outcomes_tenant_source ON public.loop_outcome_events USING btree (tenant_id, source_type, source_id);
...
--
-- Name: idx_memory_derivations_tenant_child; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_derivations_tenant_child ON public.memory_derivations USING btree (tenant_id, child_source, child_id);


--
-- Name: idx_memory_derivations_tenant_parent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_derivations_tenant_parent ON public.memory_derivations USING btree (tenant_id, parent_source, parent_id);
...
--
-- Name: idx_memory_erasure_requests_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_erasure_requests_tenant ON public.memory_erasure_requests USING btree (tenant_id);


--
-- Name: idx_memory_erasure_requests_tenant_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_erasure_requests_tenant_status ON public.memory_erasure_requests USING btree (tenant_id, status, created_at);


--
-- Name: idx_memory_forgetting_scheduler_state_lease; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_forgetting_scheduler_state_lease ON public.memory_forgetting_scheduler_state USING btree (lease_expires_at, tenant_id);


--
-- Name: idx_memory_forgetting_scheduler_state_scan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_forgetting_scheduler_state_scan ON public.memory_forgetting_scheduler_state USING btree (last_scanned_at, tenant_id);
...
--
-- Name: idx_memory_lifecycle_action_claims_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_lifecycle_action_claims_tenant ON public.memory_lifecycle_action_claims USING btree (tenant_id);


--
-- Name: idx_memory_lifecycle_action_claims_tenant_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_lifecycle_action_claims_tenant_source ON public.memory_lifecycle_action_claims USING btree (tenant_id, source, source_id);


--
-- Name: idx_memory_lifecycle_action_claims_tenant_status_lease; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_lifecycle_action_claims_tenant_status_lease ON public.memory_lifecycle_action_claims USING btree (tenant_id, status, lease_expires_at);


--
-- Name: idx_memory_lifecycle_audits_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_lifecycle_audits_tenant ON public.memory_lifecycle_audits USING btree (tenant_id);


--
-- Name: idx_memory_lifecycle_audits_tenant_action; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_lifecycle_audits_tenant_action ON public.memory_lifecycle_audits USING btree (tenant_id, action, source);


--
-- Name: idx_memory_lifecycle_audits_tenant_action_key; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_lifecycle_audits_tenant_action_key ON public.memory_lifecycle_audits USING btree (tenant_id, action_key);


--
-- Name: idx_memory_lifecycle_audits_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_lifecycle_audits_tenant_created ON public.memory_lifecycle_audits USING btree (tenant_id, created_at);
...
--
-- Name: idx_memory_retention_policies_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_retention_policies_tenant ON public.memory_retention_policies USING btree (tenant_id);


--
-- Name: idx_memory_retention_policies_tenant_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_retention_policies_tenant_status ON public.memory_retention_policies USING btree (tenant_id, status);
...
--
-- Name: idx_memory_tombstones_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_tombstones_tenant ON public.memory_tombstones USING btree (tenant_id);


--
-- Name: idx_memory_tombstones_tenant_digest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_tombstones_tenant_digest ON public.memory_tombstones USING btree (tenant_id, value_digest);


--
-- Name: idx_memory_tombstones_tenant_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_memory_tombstones_tenant_source ON public.memory_tombstones USING btree (tenant_id, source, source_id);
...
--
-- Name: idx_mission_evidence_mission; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mission_evidence_tenant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mission_experiments_mission; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mission_experiments_tenant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_model_harness_deltas_harness_manifest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_model_harness_deltas_harness_manifest ON public.model_harness_deltas USING btree (tenant_id, harness_manifest_id);
...
--
-- Name: idx_plans_pending_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_plans_pending_created_at ON public.plans USING btree (tenant_id, created_at) WHERE (status = 'awaiting_approval'::text);
...
--
-- Name: idx_project_compasses_project; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_project_compasses_project ON public.project_compasses USING btree (project_id);


--
-- Name: idx_project_compasses_tenant_project; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_project_compasses_tenant_project ON public.project_compasses USING btree (tenant_id, project_id);
...
--
-- Name: idx_research_evidence_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_research_evidence_tenant_created ON public.research_evidence USING btree (tenant_id, created_at);


--
-- Name: idx_research_evidence_tenant_fact; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_research_evidence_tenant_fact ON public.research_evidence USING btree (tenant_id, fact_key);
...
--
-- Name: idx_ret_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ret_tenant ON public.research_evidence_triples USING btree (tenant_id);


--
-- Name: idx_revenue_missions_tenant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_revenue_missions_tenant_stage; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_revenue_orchestrator_links_mission; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_orchestrator_links_mission ON public.revenue_orchestrator_mission_links USING btree (mission_id);


--
-- Name: idx_revenue_orchestrator_links_source_run; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_orchestrator_links_source_run ON public.revenue_orchestrator_mission_links USING btree (source_run_id);


--
-- Name: idx_revenue_orchestrator_links_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_orchestrator_links_tenant ON public.revenue_orchestrator_mission_links USING btree (tenant_id);


--
-- Name: idx_revenue_orchestrator_links_tenant_mission; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_orchestrator_links_tenant_mission ON public.revenue_orchestrator_mission_links USING btree (tenant_id, mission_id);


--
-- Name: idx_revenue_orchestrator_links_tenant_source_run; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_revenue_orchestrator_links_tenant_source_run ON public.revenue_orchestrator_mission_links USING btree (tenant_id, source_run_id);
...
--
-- Name: idx_skill_opt_candidates_skill; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_skill_opt_candidates_skill ON public.skill_optimization_candidates USING btree (skill_id);


--
-- Name: idx_skill_opt_candidates_state; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_skill_opt_candidates_state ON public.skill_optimization_candidates USING btree (state, review_deadline);


--
-- Name: idx_skill_opt_candidates_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_skill_opt_candidates_tenant ON public.skill_optimization_candidates USING btree (tenant_id);


--
-- Name: idx_skill_opt_versions_candidate; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_skill_opt_versions_candidate ON public.skill_optimization_versions USING btree (candidate_id);


--
-- Name: idx_skill_opt_versions_skill; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_skill_opt_versions_skill ON public.skill_optimization_versions USING btree (skill_id, created_at);


--
-- Name: idx_skill_opt_versions_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_skill_opt_versions_tenant ON public.skill_optimization_versions USING btree (tenant_id);
...
--
-- Name: idx_synergy_trials_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_synergy_trials_tenant ON public.synergy_trials USING btree (tenant_id);


--
-- Name: idx_synergy_trials_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_synergy_trials_tenant_created ON public.synergy_trials USING btree (tenant_id, created_at);
...
--
-- Name: idx_tool_mispicks_pair; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tool_mispicks_pair ON public.tool_mispicks USING btree (failed_tool, succeeded_tool);


--
-- Name: idx_tool_mispicks_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tool_mispicks_tenant_created ON public.tool_mispicks USING btree (tenant_id, created_at);
...
--
-- Name: idx_typesafe_fact_prefilter_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_typesafe_fact_prefilter_tenant ON public.typesafe_fact_prefilter_observations USING btree (tenant_id);
...
--
-- Name: idx_wake_trigger_event; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wake_trigger_event ON public.agent_wake_schedules USING btree (tenant_id, trigger_event) WHERE ((status = 'pending'::text) AND (trigger_event IS NOT NULL));
...
--
-- Name: idx_web_collection_runs_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_web_collection_runs_tenant ON public.web_collection_runs USING btree (tenant_id);


--
-- Name: idx_web_collection_runs_tenant_lease; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_web_collection_runs_tenant_lease ON public.web_collection_runs USING btree (tenant_id, lease_expires_at);


--
-- Name: idx_web_domain_cooldowns_expiry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_web_domain_cooldowns_expiry ON public.web_domain_cooldowns USING btree (cooldown_until);


--
-- Name: idx_web_domain_cooldowns_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_web_domain_cooldowns_tenant ON public.web_domain_cooldowns USING btree (tenant_id);


--
-- Name: idx_web_domain_usage_events_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_web_domain_usage_events_tenant ON public.web_domain_usage_events USING btree (tenant_id);


--
-- Name: idx_web_domain_usage_events_tenant_host_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_web_domain_usage_events_tenant_host_time ON public.web_domain_usage_events USING btree (tenant_id, hostname, occurred_at);


--
-- Name: idx_webhook_trigger_events_tenant_trigger_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_webhook_trigger_events_tenant_trigger_created ON public.webhook_trigger_events USING btree (tenant_id, trigger_id, created_at DESC);


--
-- Name: idx_webhook_triggers_tenant_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_webhook_triggers_tenant_created ON public.webhook_triggers USING btree (tenant_id, created_at DESC);
...
--
-- Name: plans_auto_apply_source_ref_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX plans_auto_apply_source_ref_unique ON public.plans USING btree (tenant_id, source, source_ref) WHERE ((source = 'agentic-engine.auto-apply'::text) AND (source_ref IS NOT NULL));


--
-- Name: plans_stale_recovery_source_ref_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX plans_stale_recovery_source_ref_unique ON public.plans USING btree (tenant_id, source, source_ref) WHERE ((source = 'stale-plan-recovery'::text) AND (source_ref IS NOT NULL));
...
--
-- Name: repair_handoff_requests_claim_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX repair_handoff_requests_claim_idx ON public.repair_handoff_requests USING btree (tenant_id, status, claim_expires_at);


--
-- Name: repair_handoff_requests_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX repair_handoff_requests_created_idx ON public.repair_handoff_requests USING btree (created_at);


--
-- Name: repair_handoff_requests_identity_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX repair_handoff_requests_identity_unique ON public.repair_handoff_requests USING btree (tenant_id, repair_identity);


--
-- Name: repair_handoff_requests_nonce_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX repair_handoff_requests_nonce_unique ON public.repair_handoff_requests USING btree (tenant_id, nonce);


--
-- Name: repair_handoff_requests_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX repair_handoff_requests_status_idx ON public.repair_handoff_requests USING btree (tenant_id, status);


--
-- Name: repair_handoff_requests_tenant_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX repair_handoff_requests_tenant_idx ON public.repair_handoff_requests USING btree (tenant_id);
...
--
-- Name: uidx_account_erasure_receipts_request_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_account_erasure_receipts_request_key ON public.account_erasure_receipts USING btree (request_key);


--
-- Name: uidx_delegation_supervisor_receipts_tenant_attempt_policy; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_delegation_supervisor_receipts_tenant_attempt_policy ON public.delegation_supervisor_receipts USING btree (tenant_id, delegation_id, attempt_id, policy_version);


--
-- Name: uidx_memory_derivations_tenant_edge; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_memory_derivations_tenant_edge ON public.memory_derivations USING btree (tenant_id, parent_source, parent_id, child_source, child_id, relationship);


--
-- Name: uidx_memory_erasure_requests_tenant_request_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_memory_erasure_requests_tenant_request_key ON public.memory_erasure_requests USING btree (tenant_id, request_key);


--
-- Name: uidx_memory_forgetting_scheduler_state_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_memory_forgetting_scheduler_state_tenant ON public.memory_forgetting_scheduler_state USING btree (tenant_id);


--
-- Name: uidx_memory_lifecycle_action_claims_tenant_action_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_memory_lifecycle_action_claims_tenant_action_key ON public.memory_lifecycle_action_claims USING btree (tenant_id, action_key);


--
-- Name: uidx_memory_lifecycle_action_claims_tenant_source_policy_action; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_memory_lifecycle_action_claims_tenant_source_policy_action ON public.memory_lifecycle_action_claims USING btree (tenant_id, source, source_id, policy_version, action);


--
-- Name: uidx_memory_retention_policies_tenant_version; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_memory_retention_policies_tenant_version ON public.memory_retention_policies USING btree (tenant_id, version);


--
-- Name: uidx_memory_tombstones_tenant_source_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_memory_tombstones_tenant_source_id ON public.memory_tombstones USING btree (tenant_id, source, source_id);


--
-- Name: uidx_skill_opt_candidates_identity; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_skill_opt_candidates_identity ON public.skill_optimization_candidates USING btree (tenant_id, identity_key);


--
-- Name: uidx_web_collection_runs_tenant_run; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_web_collection_runs_tenant_run ON public.web_collection_runs USING btree (tenant_id, run_key);


--
-- Name: uidx_web_domain_cooldowns_tenant_host; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uidx_web_domain_cooldowns_tenant_host ON public.web_domain_cooldowns USING btree (tenant_id, hostname);
...
--
-- Name: uniq_project_compasses_tenant_project; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uniq_project_compasses_tenant_project ON public.project_compasses USING btree (tenant_id, project_id);


--
-- Name: uniq_projects_tenant_id_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uniq_projects_tenant_id_id ON public.projects USING btree (tenant_id, id);
...
--
-- Name: uq_cmmc_exports_tenant_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_cmmc_exports_tenant_idempotency ON public.cmmc_report_exports USING btree (tenant_id, idempotency_key);


--
-- Name: uq_cmmc_invites_tenant_token_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_cmmc_invites_tenant_token_hash ON public.cmmc_assessment_invitations USING btree (tenant_id, token_hash);


--
-- Name: uq_cmmc_snapshots_tenant_assessment_revision; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_cmmc_snapshots_tenant_assessment_revision ON public.cmmc_assessment_snapshots USING btree (tenant_id, assessment_id, revision);


--
-- Name: uq_commercial_research_opportunities_tenant_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_commercial_research_opportunities_tenant_idempotency ON public.commercial_research_opportunities USING btree (tenant_id, idempotency_key);
...
--
-- Name: uq_derived_api_recipes_tenant_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_derived_api_recipes_tenant_name ON public.derived_api_recipes USING btree (tenant_id, name);


--
-- Name: uq_dfy_intake_forms_token; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_dfy_intake_forms_token ON public.dfy_intake_forms USING btree (token);


--
-- Name: uq_hvac_missed_call_workspaces_tenant_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_hvac_missed_call_workspaces_tenant_idempotency ON public.hvac_missed_call_workspaces USING btree (tenant_id, idempotency_key);


--
-- Name: uq_knowledge_triples_tenant_norm; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_knowledge_triples_tenant_norm ON public.knowledge_triples USING btree (tenant_id, norm_key);


--
-- Name: uq_loop_edges_tenant_edge; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_loop_edges_tenant_edge ON public.loop_graph_edges USING btree (tenant_id, edge_key);


--
-- Name: uq_loop_outcomes_tenant_event; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_loop_outcomes_tenant_event ON public.loop_outcome_events USING btree (tenant_id, event_key);
...
--
-- Name: uq_mission_evidence_tenant_source_ref; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_ret_tenant_norm; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_ret_tenant_norm ON public.research_evidence_triples USING btree (tenant_id, norm_key);
...
--
-- Name: uq_synergy_trials_tenant_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_synergy_trials_tenant_idempotency ON public.synergy_trials USING btree (tenant_id, idempotency_key);
...
--
-- Name: agent_knowledge memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.agent_knowledge FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: compaction_archives memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.compaction_archives FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: conversation_facts memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.conversation_facts FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: graph_memory memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.graph_memory FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: graph_memory_links memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.graph_memory_links FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: knowledge_nudges memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.knowledge_nudges FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: knowledge_triples memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.knowledge_triples FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: memory_entries memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.memory_entries FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: memory_links memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.memory_links FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();


--
-- Name: messages memory_tombstone_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER memory_tombstone_guard BEFORE INSERT OR UPDATE ON public.messages FOR EACH ROW EXECUTE FUNCTION public.memory_tombstone_guard();
...
--
-- Name: agent_recovery_manifests agent_recovery_manifests_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.agent_recovery_manifests
    ADD CONSTRAINT agent_recovery_manifests_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: artifact_events artifact_events_artifact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.artifact_events
    ADD CONSTRAINT artifact_events_artifact_id_fkey FOREIGN KEY (artifact_id) REFERENCES public.artifact_records(id) ON DELETE CASCADE;


--
-- Name: artifact_events artifact_events_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.artifact_events
    ADD CONSTRAINT artifact_events_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: artifact_records artifact_records_delivery_log_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.artifact_records
    ADD CONSTRAINT artifact_records_delivery_log_id_fkey FOREIGN KEY (delivery_log_id) REFERENCES public.delivery_logs(id) ON DELETE SET NULL;


--
-- Name: artifact_records artifact_records_file_storage_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.artifact_records
    ADD CONSTRAINT artifact_records_file_storage_id_fkey FOREIGN KEY (file_storage_id) REFERENCES public.file_storage(id) ON DELETE SET NULL;


--
-- Name: artifact_records artifact_records_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.artifact_records
    ADD CONSTRAINT artifact_records_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: cmmc_assessment_invitations cmmc_assessment_invitations_assessment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_invitations
    ADD CONSTRAINT cmmc_assessment_invitations_assessment_id_fkey FOREIGN KEY (assessment_id) REFERENCES public.cmmc_assessments(id) ON DELETE CASCADE;


--
-- Name: cmmc_assessment_invitations cmmc_assessment_invitations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_invitations
    ADD CONSTRAINT cmmc_assessment_invitations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: cmmc_assessment_snapshots cmmc_assessment_snapshots_assessment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_snapshots
    ADD CONSTRAINT cmmc_assessment_snapshots_assessment_id_fkey FOREIGN KEY (assessment_id) REFERENCES public.cmmc_assessments(id) ON DELETE CASCADE;


--
-- Name: cmmc_assessment_snapshots cmmc_assessment_snapshots_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessment_snapshots
    ADD CONSTRAINT cmmc_assessment_snapshots_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: cmmc_assessments cmmc_assessments_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessments
    ADD CONSTRAINT cmmc_assessments_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE SET NULL;


--
-- Name: cmmc_assessments cmmc_assessments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_assessments
    ADD CONSTRAINT cmmc_assessments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: cmmc_report_exports cmmc_report_exports_assessment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_report_exports
    ADD CONSTRAINT cmmc_report_exports_assessment_id_fkey FOREIGN KEY (assessment_id) REFERENCES public.cmmc_assessments(id) ON DELETE CASCADE;


--
-- Name: cmmc_report_exports cmmc_report_exports_snapshot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_report_exports
    ADD CONSTRAINT cmmc_report_exports_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES public.cmmc_assessment_snapshots(id) ON DELETE CASCADE;


--
-- Name: cmmc_report_exports cmmc_report_exports_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cmmc_report_exports
    ADD CONSTRAINT cmmc_report_exports_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: commercial_research_opportunities commercial_research_opportunities_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commercial_research_opportunities
    ADD CONSTRAINT commercial_research_opportunities_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: delegation_supervisor_receipts delegation_supervisor_receipts_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegation_supervisor_receipts
    ADD CONSTRAINT delegation_supervisor_receipts_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: derived_api_recipes derived_api_recipes_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.derived_api_recipes
    ADD CONSTRAINT derived_api_recipes_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);


--
-- Name: eval_runs eval_runs_harness_manifest_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.eval_runs
    ADD CONSTRAINT eval_runs_harness_manifest_tenant_fk FOREIGN KEY (tenant_id, harness_manifest_id) REFERENCES public.harness_manifests(tenant_id, id) ON DELETE CASCADE;
...
--
-- Name: loop_graph_edges fk_loop_edges_source_tenant; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loop_graph_edges
    ADD CONSTRAINT fk_loop_edges_source_tenant FOREIGN KEY (source_event_id, tenant_id) REFERENCES public.loop_outcome_events(id, tenant_id) ON DELETE RESTRICT;


--
-- Name: loop_graph_edges fk_loop_edges_target_tenant; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loop_graph_edges
    ADD CONSTRAINT fk_loop_edges_target_tenant FOREIGN KEY (target_event_id, tenant_id) REFERENCES public.loop_outcome_events(id, tenant_id) ON DELETE RESTRICT;


--
-- Name: project_compasses fk_project_compasses_tenant_project; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_compasses
    ADD CONSTRAINT fk_project_compasses_tenant_project FOREIGN KEY (project_id, tenant_id) REFERENCES public.projects(id, tenant_id) ON DELETE CASCADE;


--
-- Name: skill_optimization_versions fk_skill_opt_versions_candidate_tenant; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_versions
    ADD CONSTRAINT fk_skill_opt_versions_candidate_tenant FOREIGN KEY (candidate_id, tenant_id) REFERENCES public.skill_optimization_candidates(id, tenant_id);


--
-- Name: webhook_trigger_events fk_webhook_trigger_events_tenant_trigger; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.webhook_trigger_events
    ADD CONSTRAINT fk_webhook_trigger_events_tenant_trigger FOREIGN KEY (tenant_id, trigger_id) REFERENCES public.webhook_triggers(tenant_id, id) ON DELETE CASCADE;
...
--
-- Name: harness_manifests harness_manifests_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.harness_manifests
    ADD CONSTRAINT harness_manifests_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: hvac_missed_call_workspaces hvac_missed_call_workspaces_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hvac_missed_call_workspaces
    ADD CONSTRAINT hvac_missed_call_workspaces_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: memory_derivations memory_derivations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_derivations
    ADD CONSTRAINT memory_derivations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: memory_erasure_requests memory_erasure_requests_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_erasure_requests
    ADD CONSTRAINT memory_erasure_requests_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: memory_forgetting_scheduler_state memory_forgetting_scheduler_state_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_forgetting_scheduler_state
    ADD CONSTRAINT memory_forgetting_scheduler_state_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: memory_lifecycle_action_claims memory_lifecycle_action_claims_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_lifecycle_action_claims
    ADD CONSTRAINT memory_lifecycle_action_claims_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: memory_lifecycle_audits memory_lifecycle_audits_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_lifecycle_audits
    ADD CONSTRAINT memory_lifecycle_audits_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: memory_retention_policies memory_retention_policies_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_retention_policies
    ADD CONSTRAINT memory_retention_policies_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: memory_tombstones memory_tombstones_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.memory_tombstones
    ADD CONSTRAINT memory_tombstones_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: mission_evidence mission_evidence_mission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mission_experiments mission_experiments_mission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: model_harness_deltas model_harness_deltas_harness_manifest_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.model_harness_deltas
    ADD CONSTRAINT model_harness_deltas_harness_manifest_tenant_fk FOREIGN KEY (tenant_id, harness_manifest_id) REFERENCES public.harness_manifests(tenant_id, id) ON DELETE CASCADE;
...
--
-- Name: project_compasses project_compasses_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_compasses
    ADD CONSTRAINT project_compasses_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;


--
-- Name: project_compasses project_compasses_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_compasses
    ADD CONSTRAINT project_compasses_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: repair_handoff_requests repair_handoff_requests_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repair_handoff_requests
    ADD CONSTRAINT repair_handoff_requests_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: revenue_orchestrator_mission_links revenue_orchestrator_links_tenant_mission_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_orchestrator_mission_links
    ADD CONSTRAINT revenue_orchestrator_links_tenant_mission_fk FOREIGN KEY (tenant_id, mission_id) REFERENCES public.revenue_missions(tenant_id, id);


--
-- Name: revenue_orchestrator_mission_links revenue_orchestrator_links_tenant_source_run_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_orchestrator_mission_links
    ADD CONSTRAINT revenue_orchestrator_links_tenant_source_run_fk FOREIGN KEY (tenant_id, source_run_id) REFERENCES public.agent_runs(tenant_id, id);


--
-- Name: revenue_orchestrator_mission_links revenue_orchestrator_mission_links_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.revenue_orchestrator_mission_links
    ADD CONSTRAINT revenue_orchestrator_mission_links_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: skill_optimization_candidates skill_optimization_candidates_previous_version_id_skill_optimiz; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_candidates
    ADD CONSTRAINT skill_optimization_candidates_previous_version_id_skill_optimiz FOREIGN KEY (previous_version_id) REFERENCES public.skill_optimization_versions(id) ON DELETE SET NULL;


--
-- Name: skill_optimization_candidates skill_optimization_candidates_promoted_version_id_skill_optimiz; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_candidates
    ADD CONSTRAINT skill_optimization_candidates_promoted_version_id_skill_optimiz FOREIGN KEY (promoted_version_id) REFERENCES public.skill_optimization_versions(id) ON DELETE SET NULL;


--
-- Name: skill_optimization_candidates skill_optimization_candidates_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_candidates
    ADD CONSTRAINT skill_optimization_candidates_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skills(id) ON DELETE SET NULL;


--
-- Name: skill_optimization_candidates skill_optimization_candidates_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_candidates
    ADD CONSTRAINT skill_optimization_candidates_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: skill_optimization_versions skill_optimization_versions_skill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_versions
    ADD CONSTRAINT skill_optimization_versions_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skills(id);


--
-- Name: skill_optimization_versions skill_optimization_versions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.skill_optimization_versions
    ADD CONSTRAINT skill_optimization_versions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: synergy_trials synergy_trials_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.synergy_trials
    ADD CONSTRAINT synergy_trials_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: typesafe_fact_prefilter_observations typesafe_fact_prefilter_observations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.typesafe_fact_prefilter_observations
    ADD CONSTRAINT typesafe_fact_prefilter_observations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: web_collection_runs web_collection_runs_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_collection_runs
    ADD CONSTRAINT web_collection_runs_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: web_domain_cooldowns web_domain_cooldowns_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_domain_cooldowns
    ADD CONSTRAINT web_domain_cooldowns_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: web_domain_usage_events web_domain_usage_events_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.web_domain_usage_events
    ADD CONSTRAINT web_domain_usage_events_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: skill_optimization_candidates r120_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY r120_tenant_isolation ON public.skill_optimization_candidates USING (((NULLIF(current_setting('app.current_tenant'::text, true), ''::text) IS NULL) OR (tenant_id = (NULLIF(current_setting('app.current_tenant'::text, true), ''::text))::integer))) WITH CHECK (((NULLIF(current_setting('app.current_tenant'::text, true), ''::text) IS NULL) OR (tenant_id = (NULLIF(current_setting('app.current_tenant'::text, true), ''::text))::integer)));


--
-- Name: skill_optimization_versions r120_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY r120_tenant_isolation ON public.skill_optimization_versions USING (((NULLIF(current_setting('app.current_tenant'::text, true), ''::text) IS NULL) OR (tenant_id = (NULLIF(current_setting('app.current_tenant'::text, true), ''::text))::integer))) WITH CHECK (((NULLIF(current_setting('app.current_tenant'::text, true), ''::text) IS NULL) OR (tenant_id = (NULLIF(current_setting('app.current_tenant'::text, true), ''::text))::integer)));


--
-- Name: skill_optimization_candidates; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.skill_optimization_candidates ENABLE ROW LEVEL SECURITY;

--
-- Name: skill_optimization_versions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.skill_optimization_versions ENABLE ROW LEVEL SECURITY;

--
-- PostgreSQL database dump complete
--

\unrestrict GH61KSoARsWhjyeSSVUqPELFq9eMz7BLDtrdTa7adTDTWdOdeQ2ubuzTvorf0aR
